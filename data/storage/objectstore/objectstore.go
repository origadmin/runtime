...
import (
	filev1 "github.com/origadmin/runtime/api/gen/go/config/data/file/v1" // Use filev1
...
func New(cfg *filev1.FilestoreConfig) (storageiface.ObjectStore, error) { // Use filev1.FilestoreConfig
	if cfg == nil {
