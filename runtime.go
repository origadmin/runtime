...
// These match the methods generated by protoc-gen-go.
type (
...
// NewWithAppInfo creates a new App instance using a pre-configured *appv1.App instance.
// This constructor is useful when the application metadata is already prepared.
...
// This constructor provides maximum flexibility.
func NewWithOptions(opts ...Option) *App {
	return NewWithAppInfo(NewAppInfoBuilder(), opts...)
}
...
func (r *App) StructuredConfig() contracts.StructuredConfig {
