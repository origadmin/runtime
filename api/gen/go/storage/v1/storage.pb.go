...
const file_storage_v1_storage_proto_rawDesc = "" +
	...
	"storage.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x17validate/validate.proto\"\xfb\x01\n" +
	"\tMigration\x12;\n" +
	...
	"\x04mode\x18\x05 \x01(\tB\x14\xbaG\x11\x92\x02\x0emigration modeR\x04mode\"\xc6\a\n" +
	"\bDatabase\x129\n" +
	...
	"\x06source\x18\x03 \x01(\tB\x1c\xbaG\x19\x92\x02\x16data source dsn stringR\x06source\x12I\n" +
	"\tmigration\x18\n" +
	" \x01(\v2\x15.storage.v1.MigrationB\x14\xbaG\x11\x92\x02\x0edata migrationR\tmigration\x12>\n" +
	...
	"\x0fconnect_timeout\x18\b \x01(\x03B/\xfaB\x04\"\x02(\x00\xbaG%\x92\x02\"Connection timeout in millisecondsR\x0fconnect_timeout\"\xd6\x03\n" +
	"\x05Cache\x12T\n" +
	...
	"cache nameR\x04name\x12X\n" +
	"\tmemcached\x18\n" +
	" \x01(\v2\x15.storage.v1.MemcachedB#\xbaG \x92\x02\x1dmemcached cache configurationR\tmemcached\x12L\n" +
	"\x06memory\x18\v \x01(\v2\x12.storage.v1.MemoryB \xbaG\x1d\x92\x02\x1amemory cache configurationR\x06memory\x12H\n" +
	"\x05redis\x18\f \x01(\v2\x11.storage.v1.RedisB\x1f\xbaG\x1c\x92\x02\x19redis cache configurationR\x05redis\x12_\n" +
	...
	"\tFileLocal\x12(\n" +
	"\x04root\x18\x01 \x01(\tB\x14\xbaG\x11\x92\x02\x0eroot directoryR\x04root\"\xca\x02\n" +
	"\tFileStore\x12E\n" +
	"\x06driver\x18\x01 \x01(\tB-\xfaB\x0er\fR\x05localR\x03oss\xbaG\x19\x92\x02\x16file store driver nameR\x06driver\x12W\n" +
	"\x05local\x18\x02 \x01(\v2\x15.storage.v1.FileLocalB%\xbaG\"\x92\x02\x1flocal file system configurationH\x00R\x05local\x88\x01\x01\x12P\n" +
	"\x03oss\x18\x03 \x01(\v2\x0f.storage.v1.OssB(\xbaG%\x92\x02\"cloud object storage configurationH\x01R\x03oss\x88\x01\x01\x129\n" +
	"\n" +
	...
	"\aStorage\x12p\n" +
	"\n" +
	"filestores\x18\x01 \x03(\v2#.storage.v1.Storage.FilestoresEntryB+\xbaG(\x92\x02%map of named FileStore configurationsR\n" +
	"filestores\x12`\n" +
	"\x06caches\x18\x02 \x03(\v2\x1f.storage.v1.Storage.CachesEntryB'\xbaG$\x92\x02!map of named Cache configurationsR\x06caches\x12l\n" +
	"\tdatabases\x18\x03 \x03(\v2\".storage.v1.Storage.DatabasesEntryB*\xbaG'\x92\x02$map of named Database configurationsR\tdatabases\x12O\n" +
	...
	"\x10default_database\x18\x06 \x01(\tB\x1b\xbaG\x18\x92\x02\x15default database nameH\x02R\x10default_database\x88\x01\x01\x1aT\n" +
	"\x0fFilestoresEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12+\n" +
	"\x05value\x18\x02 \x01(\v2\x15.storage.v1.FileStoreR\x05value:\x028\x01\x1aL\n" +
	"\vCachesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12'\n" +
	"\x05value\x18\x02 \x01(\v2\x11.storage.v1.CacheR\x05value:\x028\x01\x1aR\n" +
	"\x0eDatabasesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.storage.v1.DatabaseR\x05value:\x028\x01B\x14\n" +
	"\x12_default_filestoreB\x10\n" +
	"\x0e_default_cacheB\x13\n" +
	"\x11_default_databaseB\xa8\x01\n" +
	"\x0ecom.storage.v1B\fStorageProtoP\x01Z<github.com/origadmin/runtime/api/gen/go/storage/v1;storagev1\xf8\x01\x01\xa2\x02\x03SXX\xaa\x02\n" +
	"Storage.V1\xca\x02\n" +
...
var file_storage_v1_storage_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_storage_v1_storage_proto_goTypes = []any{
	(*Migration)(nil), // 0: storage.v1.Migration
	(*Database)(nil),  // 1: storage.v1.Database
	(*Redis)(nil),     // 2: storage.v1.Redis
	(*Memcached)(nil), // 3: storage.v1.Memcached
	(*Memory)(nil),    // 4: storage.v1.Memory
	(*Mongo)(nil),     // 5: storage.v1.Mongo
	(*Cache)(nil),     // 6: storage.v1.Cache
	(*Oss)(nil),       // 7: storage.v1.Oss
	(*FileLocal)(nil), // 8: storage.v1.FileLocal
	(*FileStore)(nil), // 9: storage.v1.FileStore
	(*Storage)(nil),   // 10: storage.v1.Storage
	nil,               // 11: storage.v1.Storage.FilestoresEntry
	nil,               // 12: storage.v1.Storage.CachesEntry
	nil,               // 13: storage.v1.Storage.DatabasesEntry
}
var file_storage_v1_storage_proto_depIdxs = []int32{
	0,  // 0: storage.v1.Database.migration:type_name -> storage.v1.Migration
	3,  // 1: storage.v1.Cache.memcached:type_name -> storage.v1.Memcached
	4,  // 2: storage.v1.Cache.memory:type_name -> storage.v1.Memory
	2,  // 3: storage.v1.Cache.redis:type_name -> storage.v1.Redis
	8,  // 4: storage.v1.FileStore.local:type_name -> storage.v1.FileLocal
	7,  // 5: storage.v1.FileStore.oss:type_name -> storage.v1.Oss
	11, // 6: storage.v1.Storage.filestores:type_name -> storage.v1.Storage.FilestoresEntry
	12, // 7: storage.v1.Storage.caches:type_name -> storage.v1.Storage.CachesEntry
	13, // 8: storage.v1.Storage.databases:type_name -> storage.v1.Storage.DatabasesEntry
	9,  // 9: storage.v1.Storage.FilestoresEntry.value:type_name -> storage.v1.FileStore
	6,  // 10: storage.v1.Storage.CachesEntry.value:type_name -> storage.v1.Cache
	1,  // 11: storage.v1.Storage.DatabasesEntry.value:type_name -> storage.v1.Database
...
func file_storage_v1_storage_proto_init() {
	...
	file_storage_v1_storage_proto_msgTypes[9].OneofWrappers = []any{}
