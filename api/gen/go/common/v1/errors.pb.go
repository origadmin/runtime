...
func (ErrorReason) Descriptor() protoreflect.EnumDescriptor {
	return file_common_v1_errors_proto_enumTypes[1].Descriptor()
}

func (ErrorReason) Type() protoreflect.EnumType {
	return &file_common_v1_errors_proto_enumTypes[1]
}
...
type ErrorMetadata struct {
	...
	Category ErrorCategory `protobuf:"varint,1,opt,name=category,proto3,enum=common.v1.ErrorCategory" json:"category,omitempty"`
...
const file_common_v1_errors_proto_rawDesc = "" +
	"\n" +
	"\x16common/v1/errors.proto\x12\tcommon.v1\x1a\x13errors/errors.proto\"\xc6\x01\n" +
	"\rErrorMetadata\x124\n" +
	"\bcategory\x18\x01 \x01(\x0e2\x18.common.v1.ErrorCategoryR\bcategory\x12B\n" +
	"\bmetadata\x18\x02 \x03(\v2&.common.v1.ErrorMetadata.MetadataEntryR\bmetadata\x1a;\n" +
	...
	"\x12REGISTRY_NOT_FOUND\x10\xf0.\x1a\x04\xa8E\x94\x03\x1a\x04\xa0E\xf4\x03B\x9d\x01\n" +
	"\rcom.common.v1B\vErrorsProtoP\x01Z:github.com/origadmin/runtime/api/gen/go/common/v1;commonv1\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
...
var file_common_v1_errors_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_common_v1_errors_proto_goTypes = []any{
	...
	(*ErrorMetadata)(nil), // 2: common.v1.ErrorMetadata
	nil,                   // 3: common.v1.ErrorMetadata.MetadataEntry
}
var file_common_v1_errors_proto_depIdxs = []int32{
	0, // 0: common.v1.ErrorMetadata.category:type_name -> common.v1.ErrorCategory
	3, // 1: common.v1.ErrorMetadata.metadata:type_name -> common.v1.ErrorMetadata.MetadataEntry
