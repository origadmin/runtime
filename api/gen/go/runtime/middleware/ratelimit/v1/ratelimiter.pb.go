...
func (x *RateLimiter) Reset() {
	*x = RateLimiter{}
	mi := &file_runtime_middleware_ratelimit_v1_ratelimiter_proto_msgTypes[0]
...
func (*RateLimiter) Descriptor() ([]byte, []int) {
	return file_runtime_middleware_ratelimit_v1_ratelimiter_proto_rawDescGZIP(), []int{0}
}
...
func (x *RateLimiter_Redis) Reset() {
	*x = RateLimiter_Redis{}
	mi := &file_runtime_middleware_ratelimit_v1_ratelimiter_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RateLimiter_Redis) Descriptor() ([]byte, []int) {
	return file_runtime_middleware_ratelimit_v1_ratelimiter_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *RateLimiter_Memory) Reset() {
	*x = RateLimiter_Memory{}
	mi := &file_runtime_middleware_ratelimit_v1_ratelimiter_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RateLimiter_Memory) Descriptor() ([]byte, []int) {
	return file_runtime_middleware_ratelimit_v1_ratelimiter_proto_rawDescGZIP(), []int{0, 1}
}
...
var File_runtime_middleware_ratelimit_v1_ratelimiter_proto protoreflect.FileDescriptor
...
var (
	file_runtime_middleware_ratelimit_v1_ratelimiter_proto_rawDescOnce sync.Once
	file_runtime_middleware_ratelimit_v1_ratelimiter_proto_rawDescData []byte
)

func file_runtime_middleware_ratelimit_v1_ratelimiter_proto_rawDescGZIP() []byte {
	file_runtime_middleware_ratelimit_v1_ratelimiter_proto_rawDescOnce.Do(func() {
		file_runtime_middleware_ratelimit_v1_ratelimiter_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runtime_middleware_ratelimit_v1_ratelimiter_proto_rawDesc), len(file_runtime_middleware_ratelimit_v1_ratelimiter_proto_rawDesc)))
	})
	return file_runtime_middleware_ratelimit_v1_ratelimiter_proto_rawDescData
}

var file_runtime_middleware_ratelimit_v1_ratelimiter_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_runtime_middleware_ratelimit_v1_ratelimiter_proto_goTypes = []any{
...
func file_runtime_middleware_ratelimit_v1_ratelimiter_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runtime_middleware_ratelimit_v1_ratelimiter_proto_rawDesc), len(file_runtime_middleware_ratelimit_v1_ratelimiter_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runtime_middleware_ratelimit_v1_ratelimiter_proto_goTypes,
		DependencyIndexes: file_runtime_middleware_ratelimit_v1_ratelimiter_proto_depIdxs,
		MessageInfos:      file_runtime_middleware_ratelimit_v1_ratelimiter_proto_msgTypes,
	}.Build()
	File_runtime_middleware_ratelimit_v1_ratelimiter_proto = out.File
	file_runtime_middleware_ratelimit_v1_ratelimiter_proto_goTypes = nil
	file_runtime_middleware_ratelimit_v1_ratelimiter_proto_depIdxs = nil
}
