...
// 	protoc        (unknown)
// source: runtime/middleware/cors/v1/cors.proto
...
func (x *Cors) Reset() {
	*x = Cors{}
	mi := &file_runtime_middleware_cors_v1_cors_proto_msgTypes[0]
...
func (*Cors) Descriptor() ([]byte, []int) {
	return file_runtime_middleware_cors_v1_cors_proto_rawDescGZIP(), []int{0}
}
...
const file_runtime_middleware_cors_v1_cors_proto_rawDesc = "" +
	"\n" +
	"%runtime/middleware/cors/v1/cors.proto\x12\x1aruntime.middleware.cors.v1\"\xac\t\n" +
	"\x04Cors\x12\x14\n" +
	...
	"\vallow_files\x18# \x01(\bR\vallow_filesB\x84\x02\n" +
	"\x1ecom.runtime.middleware.cors.v1B\tCorsProtoP\x01ZIgithub.com/origadmin/runtime/api/gen/go/runtime/middleware/cors/v1;corsv1\xf8\x01\x01\xa2\x02\x03RMC\xaa\x02\x1aRuntime.Middleware.Cors.V1\xca\x02\x1aRuntime\\Middleware\\Cors\\V1\xe2\x02&Runtime\\Middleware\\Cors\\V1\\GPBMetadata\xea\x02\x1dRuntime::Middleware::Cors::V1b\x06proto3"

var (
	file_runtime_middleware_cors_v1_cors_proto_rawDescOnce sync.Once
	file_runtime_middleware_cors_v1_cors_proto_rawDescData []byte
)

func file_runtime_middleware_cors_v1_cors_proto_rawDescGZIP() []byte {
	file_runtime_middleware_cors_v1_cors_proto_rawDescOnce.Do(func() {
		file_runtime_middleware_cors_v1_cors_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runtime_middleware_cors_v1_cors_proto_rawDesc), len(file_runtime_middleware_cors_v1_cors_proto_rawDesc)))
	})
	return file_runtime_middleware_cors_v1_cors_proto_rawDescData
}

var file_runtime_middleware_cors_v1_cors_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_runtime_middleware_cors_v1_cors_proto_goTypes = []any{
	(*Cors)(nil), // 0: runtime.middleware.cors.v1.Cors
}
var file_runtime_middleware_cors_v1_cors_proto_depIdxs = []int32{
...
func init() { file_runtime_middleware_cors_v1_cors_proto_init() }
func file_runtime_middleware_cors_v1_cors_proto_init() {
	if File_runtime_middleware_cors_v1_cors_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runtime_middleware_cors_v1_cors_proto_rawDesc), len(file_runtime_middleware_cors_v1_cors_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runtime_middleware_cors_v1_cors_proto_goTypes,
		DependencyIndexes: file_runtime_middleware_cors_v1_cors_proto_depIdxs,
		MessageInfos:      file_runtime_middleware_cors_v1_cors_proto_msgTypes,
	}.Build()
	File_runtime_middleware_cors_v1_cors_proto = out.File
	file_runtime_middleware_cors_v1_cors_proto_goTypes = nil
	file_runtime_middleware_cors_v1_cors_proto_depIdxs = nil
}
