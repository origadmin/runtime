...
const file_runtime_data_v1_data_proto_rawDesc = "" +
	"\n" +
	"\x1aruntime/data/v1/data.proto\x12\x0fruntime.data.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a!runtime/data/cache/v1/cache.proto\x1a'runtime/data/database/v1/database.proto\x1a'runtime/data/database/v1/document.proto\x1a$runtime/data/file/v1/filestore.proto\x1a\x17validate/validate.proto\"\xe9\x04\n" +
	"\x04Data\x12`\n" +
	"\n" +
