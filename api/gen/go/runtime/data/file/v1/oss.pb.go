...
// 	protoc        (unknown)
// source: runtime/data/file/v1/oss.proto
...
func (x *OssConfig) Reset() {
	*x = OssConfig{}
	mi := &file_runtime_data_file_v1_oss_proto_msgTypes[0]
...
func (*OssConfig) Descriptor() ([]byte, []int) {
	return file_runtime_data_file_v1_oss_proto_rawDescGZIP(), []int{0}
}
...
func (x *BucketPolicy) Reset() {
	*x = BucketPolicy{}
	mi := &file_runtime_data_file_v1_oss_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BucketPolicy) Descriptor() ([]byte, []int) {
	return file_runtime_data_file_v1_oss_proto_rawDescGZIP(), []int{1}
}
...
func (x *LifecycleRule) Reset() {
	*x = LifecycleRule{}
	mi := &file_runtime_data_file_v1_oss_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LifecycleRule) Descriptor() ([]byte, []int) {
	return file_runtime_data_file_v1_oss_proto_rawDescGZIP(), []int{2}
}
...
func (x *Expiration) Reset() {
	*x = Expiration{}
	mi := &file_runtime_data_file_v1_oss_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Expiration) Descriptor() ([]byte, []int) {
	return file_runtime_data_file_v1_oss_proto_rawDescGZIP(), []int{3}
}
...
func (x *Transition) Reset() {
	*x = Transition{}
	mi := &file_runtime_data_file_v1_oss_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Transition) Descriptor() ([]byte, []int) {
	return file_runtime_data_file_v1_oss_proto_rawDescGZIP(), []int{4}
}
...
func (x *NoncurrentVersionExpiration) Reset() {
	*x = NoncurrentVersionExpiration{}
	mi := &file_runtime_data_file_v1_oss_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NoncurrentVersionExpiration) Descriptor() ([]byte, []int) {
	return file_runtime_data_file_v1_oss_proto_rawDescGZIP(), []int{5}
}
...
const file_runtime_data_file_v1_oss_proto_rawDesc = "" +
	"\n" +
	"\x1eruntime/data/file/v1/oss.proto\x12\x14runtime.data.file.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x17validate/validate.proto\"\xef\a\n" +
	"\tOssConfig\x12:\n" +
	...
	"\fread_timeout\x18\b \x01(\x03B)\xfaB\x04\"\x02(\x00\xbaG\x1f\x92\x02\x1cRead timeout in millisecondsR\fread_timeout\x12w\n" +
	"\rbucket_policy\x18\t \x01(\v2\".runtime.data.file.v1.BucketPolicyB(\xbaG%\x92\x02\"Bucket access policy configurationH\x00R\rbucket_policy\x88\x01\x01\x12w\n" +
	"\x0flifecycle_rules\x18\n" +
	" \x03(\v2#.runtime.data.file.v1.LifecycleRuleB(\xbaG%\x92\x02\"List of lifecycle management rulesR\x0flifecycle_rules\x12m\n" +
	...
	"\fBucketPolicy\x12U\n" +
	"\x0fpolicy_document\x18\x01 \x01(\tB+\xbaG(\x92\x02%Access policy document in JSON formatR\x0fpolicy_document\"\xe7\x05\n" +
	"\rLifecycleRule\x126\n" +
	...
	"\x06status\x18\x03 \x01(\tB<\xbaG9\x92\x026Status of the lifecycle rule (e.g., Enabled, Disabled)R\x06status\x12l\n" +
	"\n" +
	"expiration\x18\x04 \x01(\v2 .runtime.data.file.v1.ExpirationB%\xbaG\"\x92\x02\x1fObject expiration configurationH\x01R\n" +
	"expiration\x88\x01\x01\x12\x85\x01\n" +
	"\n" +
	"transition\x18\x05 \x01(\v2 .runtime.data.file.v1.TransitionB>\xbaG;\x92\x028Object transition to another storage class configurationH\x02R\n" +
	"transition\x88\x01\x01\x12\xb6\x01\n" +
	"\x1dnoncurrent_version_expiration\x18\x06 \x01(\v21.runtime.data.file.v1.NoncurrentVersionExpirationB8\xbaG5\x92\x022Noncurrent object version expiration configurationH\x03R\x1dnoncurrent_version_expiration\x88\x01\x01B\t\n" +
	"\a_prefixB\r\n" +
	"\v_expirationB\r\n" +
	"\v_transitionB \n" +
	...
	"\x0fnoncurrent_days\x18\x01 \x01(\x05BH\xbaGE\x92\x02BNumber of days after the object becomes noncurrent when it expiresR\x0fnoncurrent_daysB\xdc\x01\n" +
	"\x18com.runtime.data.file.v1B\bOssProtoP\x01ZCgithub.com/origadmin/runtime/api/gen/go/runtime/data/file/v1;filev1\xa2\x02\x03RDF\xaa\x02\x14Runtime.Data.File.V1\xca\x02\x14Runtime\\Data\\File\\V1\xe2\x02 Runtime\\Data\\File\\V1\\GPBMetadata\xea\x02\x17Runtime::Data::File::V1b\x06proto3"

var (
	file_runtime_data_file_v1_oss_proto_rawDescOnce sync.Once
	file_runtime_data_file_v1_oss_proto_rawDescData []byte
)

func file_runtime_data_file_v1_oss_proto_rawDescGZIP() []byte {
	file_runtime_data_file_v1_oss_proto_rawDescOnce.Do(func() {
		file_runtime_data_file_v1_oss_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runtime_data_file_v1_oss_proto_rawDesc), len(file_runtime_data_file_v1_oss_proto_rawDesc)))
	})
	return file_runtime_data_file_v1_oss_proto_rawDescData
}

var file_runtime_data_file_v1_oss_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_runtime_data_file_v1_oss_proto_goTypes = []any{
	(*OssConfig)(nil),                   // 0: runtime.data.file.v1.OssConfig
	(*BucketPolicy)(nil),                // 1: runtime.data.file.v1.BucketPolicy
	(*LifecycleRule)(nil),               // 2: runtime.data.file.v1.LifecycleRule
	(*Expiration)(nil),                  // 3: runtime.data.file.v1.Expiration
	(*Transition)(nil),                  // 4: runtime.data.file.v1.Transition
	(*NoncurrentVersionExpiration)(nil), // 5: runtime.data.file.v1.NoncurrentVersionExpiration
}
var file_runtime_data_file_v1_oss_proto_depIdxs = []int32{
	1, // 0: runtime.data.file.v1.OssConfig.bucket_policy:type_name -> runtime.data.file.v1.BucketPolicy
	2, // 1: runtime.data.file.v1.OssConfig.lifecycle_rules:type_name -> runtime.data.file.v1.LifecycleRule
	3, // 2: runtime.data.file.v1.LifecycleRule.expiration:type_name -> runtime.data.file.v1.Expiration
	4, // 3: runtime.data.file.v1.LifecycleRule.transition:type_name -> runtime.data.file.v1.Transition
	5, // 4: runtime.data.file.v1.LifecycleRule.noncurrent_version_expiration:type_name -> runtime.data.file.v1.NoncurrentVersionExpiration
...
func init() { file_runtime_data_file_v1_oss_proto_init() }
func file_runtime_data_file_v1_oss_proto_init() {
	if File_runtime_data_file_v1_oss_proto != nil {
		return
	}
	file_runtime_data_file_v1_oss_proto_msgTypes[0].OneofWrappers = []any{}
	file_runtime_data_file_v1_oss_proto_msgTypes[2].OneofWrappers = []any{}
	file_runtime_data_file_v1_oss_proto_msgTypes[3].OneofWrappers = []any{}
	file_runtime_data_file_v1_oss_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runtime_data_file_v1_oss_proto_rawDesc), len(file_runtime_data_file_v1_oss_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runtime_data_file_v1_oss_proto_goTypes,
		DependencyIndexes: file_runtime_data_file_v1_oss_proto_depIdxs,
		MessageInfos:      file_runtime_data_file_v1_oss_proto_msgTypes,
	}.Build()
	File_runtime_data_file_v1_oss_proto = out.File
	file_runtime_data_file_v1_oss_proto_goTypes = nil
	file_runtime_data_file_v1_oss_proto_depIdxs = nil
}
