...
// 	protoc        (unknown)
// source: runtime/security/authn/v1/jwt.proto
...
func (x *Config) Reset() {
	*x = Config{}
	mi := &file_runtime_security_authn_v1_jwt_proto_msgTypes[0]
...
func (*Config) Descriptor() ([]byte, []int) {
	return file_runtime_security_authn_v1_jwt_proto_rawDescGZIP(), []int{0}
}
...
const file_runtime_security_authn_v1_jwt_proto_rawDesc = "" +
	"\n" +
	"#runtime/security/authn/v1/jwt.proto\x12\x19runtime.security.authn.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x17validate/validate.proto\"\xda\x05\n" +
	...
	"token_typeB\xfe\x01\n" +
	"\x1dcom.runtime.security.authn.v1B\bJwtProtoP\x01ZIgithub.com/origadmin/runtime/api/gen/go/runtime/security/authn/v1;authnv1\xf8\x01\x01\xa2\x02\x03RSA\xaa\x02\x19Runtime.Security.Authn.V1\xca\x02\x19Runtime\\Security\\Authn\\V1\xe2\x02%Runtime\\Security\\Authn\\V1\\GPBMetadata\xea\x02\x1cRuntime::Security::Authn::V1b\x06proto3"

var (
	file_runtime_security_authn_v1_jwt_proto_rawDescOnce sync.Once
	file_runtime_security_authn_v1_jwt_proto_rawDescData []byte
)

func file_runtime_security_authn_v1_jwt_proto_rawDescGZIP() []byte {
	file_runtime_security_authn_v1_jwt_proto_rawDescOnce.Do(func() {
		file_runtime_security_authn_v1_jwt_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runtime_security_authn_v1_jwt_proto_rawDesc), len(file_runtime_security_authn_v1_jwt_proto_rawDesc)))
	})
	return file_runtime_security_authn_v1_jwt_proto_rawDescData
}

var file_runtime_security_authn_v1_jwt_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_runtime_security_authn_v1_jwt_proto_goTypes = []any{
	(*Config)(nil), // 0: runtime.security.authn.v1.Config
}
var file_runtime_security_authn_v1_jwt_proto_depIdxs = []int32{
...
func init() { file_runtime_security_authn_v1_jwt_proto_init() }
func file_runtime_security_authn_v1_jwt_proto_init() {
	if File_runtime_security_authn_v1_jwt_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runtime_security_authn_v1_jwt_proto_rawDesc), len(file_runtime_security_authn_v1_jwt_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runtime_security_authn_v1_jwt_proto_goTypes,
		DependencyIndexes: file_runtime_security_authn_v1_jwt_proto_depIdxs,
		MessageInfos:      file_runtime_security_authn_v1_jwt_proto_msgTypes,
	}.Build()
	File_runtime_security_authn_v1_jwt_proto = out.File
	file_runtime_security_authn_v1_jwt_proto_goTypes = nil
	file_runtime_security_authn_v1_jwt_proto_depIdxs = nil
}
