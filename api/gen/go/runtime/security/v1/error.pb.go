...
// 	protoc        (unknown)
// source: runtime/security/v1/error.proto
...
func (SecurityErrorReason) Descriptor() protoreflect.EnumDescriptor {
	return file_runtime_security_v1_error_proto_enumTypes[0].Descriptor()
}

func (SecurityErrorReason) Type() protoreflect.EnumType {
	return &file_runtime_security_v1_error_proto_enumTypes[0]
}
...
func (SecurityErrorReason) EnumDescriptor() ([]byte, []int) {
	return file_runtime_security_v1_error_proto_rawDescGZIP(), []int{0}
}
...
const file_runtime_security_v1_error_proto_rawDesc = "" +
	...
	"\x15INVALID_AUTHORIZATION\x10\xd0\x0f\x1a\x04\xa8E\x93\x03\x1a\x04\xa0E\xf4\x03B\xdb\x01\n" +
	"\x17com.runtime.security.v1B\n" +
	"ErrorProtoP\x01ZFgithub.com/origadmin/runtime/api/gen/go/runtime/security/v1;securityv1\xa2\x02\x03RSX\xaa\x02\x13Runtime.Security.V1\xca\x02\x13Runtime\\Security\\V1\xe2\x02\x1fRuntime\\Security\\V1\\GPBMetadata\xea\x02\x15Runtime::Security::V1b\x06proto3"

var (
	file_runtime_security_v1_error_proto_rawDescOnce sync.Once
	file_runtime_security_v1_error_proto_rawDescData []byte
)

func file_runtime_security_v1_error_proto_rawDescGZIP() []byte {
	file_runtime_security_v1_error_proto_rawDescOnce.Do(func() {
		file_runtime_security_v1_error_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runtime_security_v1_error_proto_rawDesc), len(file_runtime_security_v1_error_proto_rawDesc)))
	})
	return file_runtime_security_v1_error_proto_rawDescData
}

var file_runtime_security_v1_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_runtime_security_v1_error_proto_goTypes = []any{
	(SecurityErrorReason)(0), // 0: runtime.security.v1.SecurityErrorReason
}
var file_runtime_security_v1_error_proto_depIdxs = []int32{
...
func init() { file_runtime_security_v1_error_proto_init() }
func file_runtime_security_v1_error_proto_init() {
	if File_runtime_security_v1_error_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runtime_security_v1_error_proto_rawDesc), len(file_runtime_security_v1_error_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runtime_security_v1_error_proto_goTypes,
		DependencyIndexes: file_runtime_security_v1_error_proto_depIdxs,
		EnumInfos:         file_runtime_security_v1_error_proto_enumTypes,
	}.Build()
	File_runtime_security_v1_error_proto = out.File
	file_runtime_security_v1_error_proto_goTypes = nil
	file_runtime_security_v1_error_proto_depIdxs = nil
}
