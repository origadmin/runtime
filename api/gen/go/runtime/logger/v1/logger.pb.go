...
// 	protoc        (unknown)
// source: runtime/logger/v1/logger.proto
...
func (LoggerLevel) Descriptor() protoreflect.EnumDescriptor {
	return file_runtime_logger_v1_logger_proto_enumTypes[0].Descriptor()
}

func (LoggerLevel) Type() protoreflect.EnumType {
	return &file_runtime_logger_v1_logger_proto_enumTypes[0]
}
...
func (LoggerLevel) EnumDescriptor() ([]byte, []int) {
	return file_runtime_logger_v1_logger_proto_rawDescGZIP(), []int{0}
}
...
func (x *LoggerHookMessage) Reset() {
	*x = LoggerHookMessage{}
	mi := &file_runtime_logger_v1_logger_proto_msgTypes[0]
...
func (x *Logger) Reset() {
	*x = Logger{}
	mi := &file_runtime_logger_v1_logger_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Logger) Descriptor() ([]byte, []int) {
	return file_runtime_logger_v1_logger_proto_rawDescGZIP(), []int{1}
}
...
func (x *Logger_File) Reset() {
	*x = Logger_File{}
	mi := &file_runtime_logger_v1_logger_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Logger_File) Descriptor() ([]byte, []int) {
	return file_runtime_logger_v1_logger_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *Logger_DevLogger) Reset() {
	*x = Logger_DevLogger{}
	mi := &file_runtime_logger_v1_logger_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Logger_DevLogger) Descriptor() ([]byte, []int) {
	return file_runtime_logger_v1_logger_proto_rawDescGZIP(), []int{1, 1}
}
...
const file_runtime_logger_v1_logger_proto_rawDesc = "" +
	...
	"\x12LOGGER_LEVEL_FATAL\x10\x05B\xd1\x01\n" +
	"\x15com.runtime.logger.v1B\vLoggerProtoP\x01ZBgithub.com/origadmin/runtime/api/gen/go/runtime/logger/v1;loggerv1\xf8\x01\x01\xa2\x02\x03RLX\xaa\x02\x11Runtime.Logger.V1\xca\x02\x11Runtime\\Logger\\V1\xe2\x02\x1dRuntime\\Logger\\V1\\GPBMetadata\xea\x02\x13Runtime::Logger::V1b\x06proto3"

var (
	file_runtime_logger_v1_logger_proto_rawDescOnce sync.Once
	file_runtime_logger_v1_logger_proto_rawDescData []byte
)

func file_runtime_logger_v1_logger_proto_rawDescGZIP() []byte {
	file_runtime_logger_v1_logger_proto_rawDescOnce.Do(func() {
		file_runtime_logger_v1_logger_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runtime_logger_v1_logger_proto_rawDesc), len(file_runtime_logger_v1_logger_proto_rawDesc)))
	})
	return file_runtime_logger_v1_logger_proto_rawDescData
}

var file_runtime_logger_v1_logger_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_runtime_logger_v1_logger_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_runtime_logger_v1_logger_proto_goTypes = []any{
	(LoggerLevel)(0),          // 0: runtime.logger.v1.LoggerLevel
	(*LoggerHookMessage)(nil), // 1: runtime.logger.v1.LoggerHookMessage
	(*Logger)(nil),            // 2: runtime.logger.v1.Logger
	nil,                       // 3: runtime.logger.v1.LoggerHookMessage.FieldsEntry
	(*Logger_File)(nil),       // 4: runtime.logger.v1.Logger.File
	(*Logger_DevLogger)(nil),  // 5: runtime.logger.v1.Logger.DevLogger
}
var file_runtime_logger_v1_logger_proto_depIdxs = []int32{
	3, // 0: runtime.logger.v1.LoggerHookMessage.fields:type_name -> runtime.logger.v1.LoggerHookMessage.FieldsEntry
	4, // 1: runtime.logger.v1.Logger.file:type_name -> runtime.logger.v1.Logger.File
	5, // 2: runtime.logger.v1.Logger.dev_logger:type_name -> runtime.logger.v1.Logger.DevLogger
...
func init() { file_runtime_logger_v1_logger_proto_init() }
func file_runtime_logger_v1_logger_proto_init() {
	if File_runtime_logger_v1_logger_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runtime_logger_v1_logger_proto_rawDesc), len(file_runtime_logger_v1_logger_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runtime_logger_v1_logger_proto_goTypes,
		DependencyIndexes: file_runtime_logger_v1_logger_proto_depIdxs,
		EnumInfos:         file_runtime_logger_v1_logger_proto_enumTypes,
		MessageInfos:      file_runtime_logger_v1_logger_proto_msgTypes,
	}.Build()
	File_runtime_logger_v1_logger_proto = out.File
	file_runtime_logger_v1_logger_proto_goTypes = nil
	file_runtime_logger_v1_logger_proto_depIdxs = nil
}
