...
func (x *GrpcServerConfig) Reset() {
	*x = GrpcServerConfig{}
	mi := &file_runtime_transport_v1_grpc_proto_msgTypes[0]
...
func (*GrpcServerConfig) Descriptor() ([]byte, []int) {
	return file_runtime_transport_v1_grpc_proto_rawDescGZIP(), []int{0}
}
...
func (x *GrpcClientConfig) Reset() {
	*x = GrpcClientConfig{}
	mi := &file_runtime_transport_v1_grpc_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GrpcClientConfig) Descriptor() ([]byte, []int) {
	return file_runtime_transport_v1_grpc_proto_rawDescGZIP(), []int{1}
}
...
const file_runtime_transport_v1_grpc_proto_rawDesc = "" +
	"\n" +
	"\x1fruntime/transport/v1/grpc.proto\x12\x14runtime.transport.v1\x1a\x1egoogle/protobuf/duration.proto\x1a#runtime/transport/v1/selector.proto\x1a'runtime/security/transport/v1/tls.proto\"\xf4\x01\n" +
	...
	"\x0f_discovery_nameB\r\n" +
	"\v_tls_configB\xe1\x01\n" +
	"\x18com.runtime.transport.v1B\tGrpcProtoP\x01ZHgithub.com/origadmin/runtime/api/gen/go/runtime/transport/v1;transportv1\xa2\x02\x03RTX\xaa\x02\x14Runtime.Transport.V1\xca\x02\x14Runtime\\Transport\\V1\xe2\x02 Runtime\\Transport\\V1\\GPBMetadata\xea\x02\x16Runtime::Transport::V1b\x06proto3"

var (
	file_runtime_transport_v1_grpc_proto_rawDescOnce sync.Once
	file_runtime_transport_v1_grpc_proto_rawDescData []byte
)

func file_runtime_transport_v1_grpc_proto_rawDescGZIP() []byte {
	file_runtime_transport_v1_grpc_proto_rawDescOnce.Do(func() {
		file_runtime_transport_v1_grpc_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runtime_transport_v1_grpc_proto_rawDesc), len(file_runtime_transport_v1_grpc_proto_rawDesc)))
	})
	return file_runtime_transport_v1_grpc_proto_rawDescData
}

var file_runtime_transport_v1_grpc_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_runtime_transport_v1_grpc_proto_goTypes = []any{
	(*GrpcServerConfig)(nil),    // 0: runtime.transport.v1.GrpcServerConfig
	(*GrpcClientConfig)(nil),    // 1: runtime.transport.v1.GrpcClientConfig
	(*durationpb.Duration)(nil), // 2: google.protobuf.Duration
	(*v1.TLSConfig)(nil),        // 3: runtime.security.transport.v1.TLSConfig
	(*SelectorConfig)(nil),      // 4: runtime.transport.v1.SelectorConfig
}
var file_runtime_transport_v1_grpc_proto_depIdxs = []int32{
	2, // 0: runtime.transport.v1.GrpcServerConfig.timeout:type_name -> google.protobuf.Duration
	3, // 1: runtime.transport.v1.GrpcServerConfig.tls_config:type_name -> runtime.security.transport.v1.TLSConfig
	2, // 2: runtime.transport.v1.GrpcClientConfig.timeout:type_name -> google.protobuf.Duration
	4, // 3: runtime.transport.v1.GrpcClientConfig.selector:type_name -> runtime.transport.v1.SelectorConfig
	3, // 4: runtime.transport.v1.GrpcClientConfig.tls_config:type_name -> runtime.security.transport.v1.TLSConfig
...
func init() { file_runtime_transport_v1_grpc_proto_init() }
func file_runtime_transport_v1_grpc_proto_init() {
	if File_runtime_transport_v1_grpc_proto != nil {
		return
	}
	file_runtime_transport_v1_selector_proto_init()
	file_runtime_transport_v1_grpc_proto_msgTypes[0].OneofWrappers = []any{}
	file_runtime_transport_v1_grpc_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runtime_transport_v1_grpc_proto_rawDesc), len(file_runtime_transport_v1_grpc_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runtime_transport_v1_grpc_proto_goTypes,
		DependencyIndexes: file_runtime_transport_v1_grpc_proto_depIdxs,
		MessageInfos:      file_runtime_transport_v1_grpc_proto_msgTypes,
	}.Build()
	File_runtime_transport_v1_grpc_proto = out.File
	file_runtime_transport_v1_grpc_proto_goTypes = nil
	file_runtime_transport_v1_grpc_proto_depIdxs = nil
}
