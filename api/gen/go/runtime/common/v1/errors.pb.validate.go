...
// ValidateAll checks the field values on ErrorMetadata with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in ErrorMetadataMultiError, or
// nil if none found.
func (m *ErrorMetadata) ValidateAll() error {
	return m.validate(true)
}

func (m *ErrorMetadata) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ErrorMetadataMultiError(errors)
	}

	return nil
}

// ErrorMetadataMultiError is an error wrapping multiple validation errors
// returned by ErrorMetadata.ValidateAll() if the designated constraints
// aren't met.
...
func (m ErrorMetadataMultiError) AllErrors() []error { return m }
