...
// 	protoc        (unknown)
// source: runtime/common/v1/pagination.proto
...
func (x *PaginationRequest) Reset() {
	*x = PaginationRequest{}
	mi := &file_runtime_common_v1_pagination_proto_msgTypes[0]
...
func (*PaginationRequest) Descriptor() ([]byte, []int) {
	return file_runtime_common_v1_pagination_proto_rawDescGZIP(), []int{0}
}
...
func (x *Pagination) Reset() {
	*x = Pagination{}
	mi := &file_runtime_common_v1_pagination_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Pagination) Descriptor() ([]byte, []int) {
	return file_runtime_common_v1_pagination_proto_rawDescGZIP(), []int{1}
}
...
const file_runtime_common_v1_pagination_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x05value:\x028\x01B\xd5\x01\n" +
	"\x15com.runtime.common.v1B\x0fPaginationProtoP\x01ZBgithub.com/origadmin/runtime/api/gen/go/runtime/common/v1;commonv1\xf8\x01\x01\xa2\x02\x03RCX\xaa\x02\x11Runtime.Common.V1\xca\x02\x11Runtime\\Common\\V1\xe2\x02\x1dRuntime\\Common\\V1\\GPBMetadata\xea\x02\x13Runtime::Common::V1b\x06proto3"

var (
	file_runtime_common_v1_pagination_proto_rawDescOnce sync.Once
	file_runtime_common_v1_pagination_proto_rawDescData []byte
)

func file_runtime_common_v1_pagination_proto_rawDescGZIP() []byte {
	file_runtime_common_v1_pagination_proto_rawDescOnce.Do(func() {
		file_runtime_common_v1_pagination_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runtime_common_v1_pagination_proto_rawDesc), len(file_runtime_common_v1_pagination_proto_rawDesc)))
	})
	return file_runtime_common_v1_pagination_proto_rawDescData
}

var file_runtime_common_v1_pagination_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_runtime_common_v1_pagination_proto_goTypes = []any{
	(*PaginationRequest)(nil),     // 0: runtime.common.v1.PaginationRequest
	(*Pagination)(nil),            // 1: runtime.common.v1.Pagination
	nil,                           // 2: runtime.common.v1.Pagination.ExtraEntry
	(*fieldmaskpb.FieldMask)(nil), // 3: google.protobuf.FieldMask
	(*anypb.Any)(nil),             // 4: google.protobuf.Any
}
var file_runtime_common_v1_pagination_proto_depIdxs = []int32{
	3, // 0: runtime.common.v1.PaginationRequest.field_mask:type_name -> google.protobuf.FieldMask
	2, // 1: runtime.common.v1.Pagination.extra:type_name -> runtime.common.v1.Pagination.ExtraEntry
	4, // 2: runtime.common.v1.Pagination.ExtraEntry.value:type_name -> google.protobuf.Any
...
func init() { file_runtime_common_v1_pagination_proto_init() }
func file_runtime_common_v1_pagination_proto_init() {
	if File_runtime_common_v1_pagination_proto != nil {
		return
	}
	file_runtime_common_v1_pagination_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runtime_common_v1_pagination_proto_rawDesc), len(file_runtime_common_v1_pagination_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runtime_common_v1_pagination_proto_goTypes,
		DependencyIndexes: file_runtime_common_v1_pagination_proto_depIdxs,
		MessageInfos:      file_runtime_common_v1_pagination_proto_msgTypes,
	}.Build()
	File_runtime_common_v1_pagination_proto = out.File
	file_runtime_common_v1_pagination_proto_goTypes = nil
	file_runtime_common_v1_pagination_proto_depIdxs = nil
}
