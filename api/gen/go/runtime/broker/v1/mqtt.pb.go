...
// 	protoc        (unknown)
// source: runtime/broker/v1/mqtt.proto
...
func (x *MqttConfig) Reset() {
	*x = MqttConfig{}
	mi := &file_runtime_broker_v1_mqtt_proto_msgTypes[0]
...
func (*MqttConfig) Descriptor() ([]byte, []int) {
	return file_runtime_broker_v1_mqtt_proto_rawDescGZIP(), []int{0}
}
...
const file_runtime_broker_v1_mqtt_proto_rawDesc = "" +
	"\n" +
	"\x1cruntime/broker/v1/mqtt.proto\x12\x11runtime.broker.v1\"\xb3\x06\n" +
	"\n" +
	"MqttConfig\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12 \n" +
	"\tclient_id\x18\x02 \x01(\tH\x00R\bclientId\x88\x01\x01\x12\x1f\n" +
	"\busername\x18\x03 \x01(\tH\x01R\busername\x88\x01\x01\x12\x1f\n" +
	"\bpassword\x18\x04 \x01(\tH\x02R\bpassword\x88\x01\x01\x12\x19\n" +
	"\x05topic\x18\x05 \x01(\tH\x03R\x05topic\x88\x01\x01\x12\x15\n" +
	"\x03qos\x18\x06 \x01(\x05H\x04R\x03qos\x88\x01\x01\x12\x1f\n" +
	"\bretained\x18\a \x01(\bH\x05R\bretained\x88\x01\x01\x12$\n" +
	"\vtls_enabled\x18\b \x01(\bH\x06R\n" +
	"tlsEnabled\x88\x01\x01\x124\n" +
	"\x14tls_client_cert_file\x18\t \x01(\tH\aR\x11tlsClientCertFile\x88\x01\x01\x122\n" +
	"\x13tls_client_key_file\x18\n" +
	" \x01(\tH\bR\x10tlsClientKeyFile\x88\x01\x01\x12,\n" +
	"\x10tls_ca_cert_file\x18\v \x01(\tH\tR\rtlsCaCertFile\x88\x01\x01\x12<\n" +
	"\x18tls_insecure_skip_verify\x18\f \x01(\bH\n" +
	"R\x15tlsInsecureSkipVerify\x88\x01\x01\x12B\n" +
	"\x1bkeep_alive_interval_seconds\x18\r \x01(\x05H\vR\x18keepAliveIntervalSeconds\x88\x01\x01\x12(\n" +
	"\rclean_session\x18\x0e \x01(\bH\fR\fcleanSession\x88\x01\x01B\f\n" +
	"\n" +
	"_client_idB\v\n" +
	"\t_usernameB\v\n" +
	"\t_passwordB\b\n" +
	...
	"\x0e_clean_sessionB\xcc\x01\n" +
	"\x15com.runtime.broker.v1B\tMqttProtoP\x01ZBgithub.com/origadmin/runtime/api/gen/go/runtime/broker/v1;brokerv1\xa2\x02\x03RBX\xaa\x02\x11Runtime.Broker.V1\xca\x02\x11Runtime\\Broker\\V1\xe2\x02\x1dRuntime\\Broker\\V1\\GPBMetadata\xea\x02\x13Runtime::Broker::V1b\x06proto3"

var (
	file_runtime_broker_v1_mqtt_proto_rawDescOnce sync.Once
	file_runtime_broker_v1_mqtt_proto_rawDescData []byte
)

func file_runtime_broker_v1_mqtt_proto_rawDescGZIP() []byte {
	file_runtime_broker_v1_mqtt_proto_rawDescOnce.Do(func() {
		file_runtime_broker_v1_mqtt_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runtime_broker_v1_mqtt_proto_rawDesc), len(file_runtime_broker_v1_mqtt_proto_rawDesc)))
	})
	return file_runtime_broker_v1_mqtt_proto_rawDescData
}

var file_runtime_broker_v1_mqtt_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_runtime_broker_v1_mqtt_proto_goTypes = []any{
	(*MqttConfig)(nil), // 0: runtime.broker.v1.MqttConfig
}
var file_runtime_broker_v1_mqtt_proto_depIdxs = []int32{
...
func init() { file_runtime_broker_v1_mqtt_proto_init() }
func file_runtime_broker_v1_mqtt_proto_init() {
	if File_runtime_broker_v1_mqtt_proto != nil {
		return
	}
	file_runtime_broker_v1_mqtt_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runtime_broker_v1_mqtt_proto_rawDesc), len(file_runtime_broker_v1_mqtt_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runtime_broker_v1_mqtt_proto_goTypes,
		DependencyIndexes: file_runtime_broker_v1_mqtt_proto_depIdxs,
		MessageInfos:      file_runtime_broker_v1_mqtt_proto_msgTypes,
	}.Build()
	File_runtime_broker_v1_mqtt_proto = out.File
	file_runtime_broker_v1_mqtt_proto_goTypes = nil
	file_runtime_broker_v1_mqtt_proto_depIdxs = nil
}
