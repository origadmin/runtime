...
func (x *RabbitMQConfig) Reset() {
	*x = RabbitMQConfig{}
	mi := &file_runtime_broker_v1_rabbitmq_proto_msgTypes[0]
...
func (*RabbitMQConfig) Descriptor() ([]byte, []int) {
	return file_runtime_broker_v1_rabbitmq_proto_rawDescGZIP(), []int{0}
}
...
const file_runtime_broker_v1_rabbitmq_proto_rawDesc = "" +
	"\n" +
	" runtime/broker/v1/rabbitmq.proto\x12\x11runtime.broker.v1\"\xdd\a\n" +
	"\x0eRabbitMQConfig\x12\x10\n" +
	"\x03uri\x18\x01 \x01(\tR\x03uri\x12\x1f\n" +
	"\bexchange\x18\x02 \x01(\tH\x00R\bexchange\x88\x01\x01\x12\x19\n" +
	"\x05queue\x18\x03 \x01(\tH\x01R\x05queue\x88\x01\x01\x12\x19\n" +
	"\x05vhost\x18\x04 \x01(\tH\x02R\x05vhost\x88\x01\x01\x12\x1f\n" +
	"\busername\x18\x05 \x01(\tH\x03R\busername\x88\x01\x01\x12\x1f\n" +
	"\bpassword\x18\x06 \x01(\tH\x04R\bpassword\x88\x01\x01\x12$\n" +
	"\vtls_enabled\x18\a \x01(\bH\x05R\n" +
	"tlsEnabled\x88\x01\x01\x124\n" +
	"\x14tls_client_cert_file\x18\b \x01(\tH\x06R\x11tlsClientCertFile\x88\x01\x01\x122\n" +
	"\x13tls_client_key_file\x18\t \x01(\tH\aR\x10tlsClientKeyFile\x88\x01\x01\x12,\n" +
	"\x10tls_ca_cert_file\x18\n" +
	" \x01(\tH\bR\rtlsCaCertFile\x88\x01\x01\x12<\n" +
	"\x18tls_insecure_skip_verify\x18\v \x01(\bH\tR\x15tlsInsecureSkipVerify\x88\x01\x01\x12&\n" +
	"\fconsumer_tag\x18\f \x01(\tH\n" +
	"R\vconsumerTag\x88\x01\x01\x121\n" +
	"\x12qos_prefetch_count\x18\r \x01(\x05H\vR\x10qosPrefetchCount\x88\x01\x01\x12/\n" +
	"\x11qos_prefetch_size\x18\x0e \x01(\x05H\fR\x0fqosPrefetchSize\x88\x01\x01\x12\"\n" +
	"\n" +
	"qos_global\x18\x0f \x01(\bH\rR\tqosGlobal\x88\x01\x01\x12\x1e\n" +
	"\bauto_ack\x18\x10 \x01(\bH\x0eR\aautoAck\x88\x01\x01\x124\n" +
	"\x13persistent_messages\x18\x11 \x01(\bH\x0fR\x12persistentMessages\x88\x01\x01B\v\n" +
	"\t_exchangeB\b\n" +
	"\x06_queueB\b\n" +
	"\x06_vhostB\v\n" +
	"\t_usernameB\v\n" +
	...
	"\v_qos_globalB\v\n" +
	"\t_auto_ackB\x16\n" +
	"\x14_persistent_messagesB\xd0\x01\n" +
	"\x15com.runtime.broker.v1B\rRabbitmqProtoP\x01ZBgithub.com/origadmin/runtime/api/gen/go/runtime/broker/v1;brokerv1\xa2\x02\x03RBX\xaa\x02\x11Runtime.Broker.V1\xca\x02\x11Runtime\\Broker\\V1\xe2\x02\x1dRuntime\\Broker\\V1\\GPBMetadata\xea\x02\x13Runtime::Broker::V1b\x06proto3"

var (
	file_runtime_broker_v1_rabbitmq_proto_rawDescOnce sync.Once
	file_runtime_broker_v1_rabbitmq_proto_rawDescData []byte
)

func file_runtime_broker_v1_rabbitmq_proto_rawDescGZIP() []byte {
	file_runtime_broker_v1_rabbitmq_proto_rawDescOnce.Do(func() {
		file_runtime_broker_v1_rabbitmq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runtime_broker_v1_rabbitmq_proto_rawDesc), len(file_runtime_broker_v1_rabbitmq_proto_rawDesc)))
	})
	return file_runtime_broker_v1_rabbitmq_proto_rawDescData
}

var file_runtime_broker_v1_rabbitmq_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_runtime_broker_v1_rabbitmq_proto_goTypes = []any{
	(*RabbitMQConfig)(nil), // 0: runtime.broker.v1.RabbitMQConfig
}
var file_runtime_broker_v1_rabbitmq_proto_depIdxs = []int32{
...
func init() { file_runtime_broker_v1_rabbitmq_proto_init() }
func file_runtime_broker_v1_rabbitmq_proto_init() {
	if File_runtime_broker_v1_rabbitmq_proto != nil {
		return
	}
	file_runtime_broker_v1_rabbitmq_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runtime_broker_v1_rabbitmq_proto_rawDesc), len(file_runtime_broker_v1_rabbitmq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runtime_broker_v1_rabbitmq_proto_goTypes,
		DependencyIndexes: file_runtime_broker_v1_rabbitmq_proto_depIdxs,
		MessageInfos:      file_runtime_broker_v1_rabbitmq_proto_msgTypes,
	}.Build()
	File_runtime_broker_v1_rabbitmq_proto = out.File
	file_runtime_broker_v1_rabbitmq_proto_goTypes = nil
	file_runtime_broker_v1_rabbitmq_proto_depIdxs = nil
}
