...
// 	protoc        (unknown)
// source: runtime/broker/redis_mq/v1/redis_mq.proto
...
func (x *RedisMqConfig) Reset() {
	*x = RedisMqConfig{}
	mi := &file_runtime_broker_redis_mq_v1_redis_mq_proto_msgTypes[0]
...
func (*RedisMqConfig) Descriptor() ([]byte, []int) {
	return file_runtime_broker_redis_mq_v1_redis_mq_proto_rawDescGZIP(), []int{0}
}
...
var File_runtime_broker_redis_mq_v1_redis_mq_proto protoreflect.FileDescriptor

const file_runtime_broker_redis_mq_v1_redis_mq_proto_rawDesc = "" +
	"\n" +
	")runtime/broker/redis_mq/v1/redis_mq.proto\x12\x1aruntime.broker.redis_mq.v1\x1a$gnostic/openapi/v3/annotations.proto\"\xcd\b\n" +
	"\rRedisMqConfig\x12G\n" +
	...
	"\x19_tls_insecure_skip_verifyB\x83\x02\n" +
	"\x1ecom.runtime.broker.redis_mq.v1B\fRedisMqProtoP\x01ZLgithub.com/origadmin/runtime/api/gen/go/runtime/broker/redis_mq/v1;redismqv1\xa2\x02\x03RBR\xaa\x02\x19Runtime.Broker.RedisMq.V1\xca\x02\x19Runtime\\Broker\\RedisMq\\V1\xe2\x02%Runtime\\Broker\\RedisMq\\V1\\GPBMetadata\xea\x02\x1cRuntime::Broker::RedisMq::V1b\x06proto3"

var (
	file_runtime_broker_redis_mq_v1_redis_mq_proto_rawDescOnce sync.Once
	file_runtime_broker_redis_mq_v1_redis_mq_proto_rawDescData []byte
)

func file_runtime_broker_redis_mq_v1_redis_mq_proto_rawDescGZIP() []byte {
	file_runtime_broker_redis_mq_v1_redis_mq_proto_rawDescOnce.Do(func() {
		file_runtime_broker_redis_mq_v1_redis_mq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runtime_broker_redis_mq_v1_redis_mq_proto_rawDesc), len(file_runtime_broker_redis_mq_v1_redis_mq_proto_rawDesc)))
	})
	return file_runtime_broker_redis_mq_v1_redis_mq_proto_rawDescData
}

var file_runtime_broker_redis_mq_v1_redis_mq_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_runtime_broker_redis_mq_v1_redis_mq_proto_goTypes = []any{
	(*RedisMqConfig)(nil), // 0: runtime.broker.redis_mq.v1.RedisMqConfig
}
var file_runtime_broker_redis_mq_v1_redis_mq_proto_depIdxs = []int32{
...
func init() { file_runtime_broker_redis_mq_v1_redis_mq_proto_init() }
func file_runtime_broker_redis_mq_v1_redis_mq_proto_init() {
	if File_runtime_broker_redis_mq_v1_redis_mq_proto != nil {
		return
	}
	file_runtime_broker_redis_mq_v1_redis_mq_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runtime_broker_redis_mq_v1_redis_mq_proto_rawDesc), len(file_runtime_broker_redis_mq_v1_redis_mq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runtime_broker_redis_mq_v1_redis_mq_proto_goTypes,
		DependencyIndexes: file_runtime_broker_redis_mq_v1_redis_mq_proto_depIdxs,
		MessageInfos:      file_runtime_broker_redis_mq_v1_redis_mq_proto_msgTypes,
	}.Build()
	File_runtime_broker_redis_mq_v1_redis_mq_proto = out.File
	file_runtime_broker_redis_mq_v1_redis_mq_proto_goTypes = nil
	file_runtime_broker_redis_mq_v1_redis_mq_proto_depIdxs = nil
}
