...
func (x *NatsConfig) Reset() {
	*x = NatsConfig{}
	mi := &file_runtime_broker_nats_v1_nats_proto_msgTypes[0]
...
func (*NatsConfig) Descriptor() ([]byte, []int) {
	return file_runtime_broker_nats_v1_nats_proto_rawDescGZIP(), []int{0}
}
...
var File_runtime_broker_nats_v1_nats_proto protoreflect.FileDescriptor

const file_runtime_broker_nats_v1_nats_proto_rawDesc = "" +
	"\n" +
	"!runtime/broker/nats/v1/nats.proto\x12\x16runtime.broker.nats.v1\x1a$gnostic/openapi/v3/annotations.proto\"\xdc\n" +
	"\n" +
	"\n" +
	"NatsConfig\x12T\n" +
	...
	"\x16_jetstream_stream_nameB\xe9\x01\n" +
	"\x1acom.runtime.broker.nats.v1B\tNatsProtoP\x01ZEgithub.com/origadmin/runtime/api/gen/go/runtime/broker/nats/v1;natsv1\xa2\x02\x03RBN\xaa\x02\x16Runtime.Broker.Nats.V1\xca\x02\x16Runtime\\Broker\\Nats\\V1\xe2\x02\"Runtime\\Broker\\Nats\\V1\\GPBMetadata\xea\x02\x19Runtime::Broker::Nats::V1b\x06proto3"

var (
	file_runtime_broker_nats_v1_nats_proto_rawDescOnce sync.Once
	file_runtime_broker_nats_v1_nats_proto_rawDescData []byte
)

func file_runtime_broker_nats_v1_nats_proto_rawDescGZIP() []byte {
	file_runtime_broker_nats_v1_nats_proto_rawDescOnce.Do(func() {
		file_runtime_broker_nats_v1_nats_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runtime_broker_nats_v1_nats_proto_rawDesc), len(file_runtime_broker_nats_v1_nats_proto_rawDesc)))
	})
	return file_runtime_broker_nats_v1_nats_proto_rawDescData
}

var file_runtime_broker_nats_v1_nats_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_runtime_broker_nats_v1_nats_proto_goTypes = []any{
	(*NatsConfig)(nil), // 0: runtime.broker.nats.v1.NatsConfig
}
var file_runtime_broker_nats_v1_nats_proto_depIdxs = []int32{
...
func init() { file_runtime_broker_nats_v1_nats_proto_init() }
func file_runtime_broker_nats_v1_nats_proto_init() {
	if File_runtime_broker_nats_v1_nats_proto != nil {
		return
	}
	file_runtime_broker_nats_v1_nats_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runtime_broker_nats_v1_nats_proto_rawDesc), len(file_runtime_broker_nats_v1_nats_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runtime_broker_nats_v1_nats_proto_goTypes,
		DependencyIndexes: file_runtime_broker_nats_v1_nats_proto_depIdxs,
		MessageInfos:      file_runtime_broker_nats_v1_nats_proto_msgTypes,
	}.Build()
	File_runtime_broker_nats_v1_nats_proto = out.File
	file_runtime_broker_nats_v1_nats_proto_goTypes = nil
	file_runtime_broker_nats_v1_nats_proto_depIdxs = nil
}
