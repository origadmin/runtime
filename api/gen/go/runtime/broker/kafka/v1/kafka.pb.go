...
// 	protoc        (unknown)
// source: runtime/broker/kafka/v1/kafka.proto
...
func (x *KafkaConfig) Reset() {
	*x = KafkaConfig{}
	mi := &file_runtime_broker_kafka_v1_kafka_proto_msgTypes[0]
...
func (*KafkaConfig) Descriptor() ([]byte, []int) {
	return file_runtime_broker_kafka_v1_kafka_proto_rawDescGZIP(), []int{0}
}
...
var File_runtime_broker_kafka_v1_kafka_proto protoreflect.FileDescriptor

const file_runtime_broker_kafka_v1_kafka_proto_rawDesc = "" +
	"\n" +
	"#runtime/broker/kafka/v1/kafka.proto\x12\x17runtime.broker.kafka.v1\x1a$gnostic/openapi/v3/annotations.proto\"\xe7\r\n" +
	"\vKafkaConfig\x12C\n" +
	...
	"\x05_acksB\x13\n" +
	"\x11_compression_typeB\xf1\x01\n" +
	"\x1bcom.runtime.broker.kafka.v1B\n" +
	"KafkaProtoP\x01ZGgithub.com/origadmin/runtime/api/gen/go/runtime/broker/kafka/v1;kafkav1\xa2\x02\x03RBK\xaa\x02\x17Runtime.Broker.Kafka.V1\xca\x02\x17Runtime\\Broker\\Kafka\\V1\xe2\x02#Runtime\\Broker\\Kafka\\V1\\GPBMetadata\xea\x02\x1aRuntime::Broker::Kafka::V1b\x06proto3"

var (
	file_runtime_broker_kafka_v1_kafka_proto_rawDescOnce sync.Once
	file_runtime_broker_kafka_v1_kafka_proto_rawDescData []byte
)

func file_runtime_broker_kafka_v1_kafka_proto_rawDescGZIP() []byte {
	file_runtime_broker_kafka_v1_kafka_proto_rawDescOnce.Do(func() {
		file_runtime_broker_kafka_v1_kafka_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runtime_broker_kafka_v1_kafka_proto_rawDesc), len(file_runtime_broker_kafka_v1_kafka_proto_rawDesc)))
	})
	return file_runtime_broker_kafka_v1_kafka_proto_rawDescData
}

var file_runtime_broker_kafka_v1_kafka_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_runtime_broker_kafka_v1_kafka_proto_goTypes = []any{
	(*KafkaConfig)(nil), // 0: runtime.broker.kafka.v1.KafkaConfig
}
var file_runtime_broker_kafka_v1_kafka_proto_depIdxs = []int32{
...
func init() { file_runtime_broker_kafka_v1_kafka_proto_init() }
func file_runtime_broker_kafka_v1_kafka_proto_init() {
	if File_runtime_broker_kafka_v1_kafka_proto != nil {
		return
	}
	file_runtime_broker_kafka_v1_kafka_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runtime_broker_kafka_v1_kafka_proto_rawDesc), len(file_runtime_broker_kafka_v1_kafka_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runtime_broker_kafka_v1_kafka_proto_goTypes,
		DependencyIndexes: file_runtime_broker_kafka_v1_kafka_proto_depIdxs,
		MessageInfos:      file_runtime_broker_kafka_v1_kafka_proto_msgTypes,
	}.Build()
	File_runtime_broker_kafka_v1_kafka_proto = out.File
	file_runtime_broker_kafka_v1_kafka_proto_goTypes = nil
	file_runtime_broker_kafka_v1_kafka_proto_depIdxs = nil
}
