...
// 	protoc        (unknown)
// source: runtime/broker/pulsar/v1/pulsar.proto
...
func (x *PulsarConfig) Reset() {
	*x = PulsarConfig{}
	mi := &file_runtime_broker_pulsar_v1_pulsar_proto_msgTypes[0]
...
func (*PulsarConfig) Descriptor() ([]byte, []int) {
	return file_runtime_broker_pulsar_v1_pulsar_proto_rawDescGZIP(), []int{0}
}
...
var File_runtime_broker_pulsar_v1_pulsar_proto protoreflect.FileDescriptor

const file_runtime_broker_pulsar_v1_pulsar_proto_rawDesc = "" +
	"\n" +
	"%runtime/broker/pulsar/v1/pulsar.proto\x12\x18runtime.broker.pulsar.v1\x1a$gnostic/openapi/v3/annotations.proto\"\xbc\t\n" +
	"\fPulsarConfig\x12c\n" +
	...
	"\x15_max_pending_messagesB\xf9\x01\n" +
	"\x1ccom.runtime.broker.pulsar.v1B\vPulsarProtoP\x01ZIgithub.com/origadmin/runtime/api/gen/go/runtime/broker/pulsar/v1;pulsarv1\xa2\x02\x03RBP\xaa\x02\x18Runtime.Broker.Pulsar.V1\xca\x02\x18Runtime\\Broker\\Pulsar\\V1\xe2\x02$Runtime\\Broker\\Pulsar\\V1\\GPBMetadata\xea\x02\x1bRuntime::Broker::Pulsar::V1b\x06proto3"

var (
	file_runtime_broker_pulsar_v1_pulsar_proto_rawDescOnce sync.Once
	file_runtime_broker_pulsar_v1_pulsar_proto_rawDescData []byte
)

func file_runtime_broker_pulsar_v1_pulsar_proto_rawDescGZIP() []byte {
	file_runtime_broker_pulsar_v1_pulsar_proto_rawDescOnce.Do(func() {
		file_runtime_broker_pulsar_v1_pulsar_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runtime_broker_pulsar_v1_pulsar_proto_rawDesc), len(file_runtime_broker_pulsar_v1_pulsar_proto_rawDesc)))
	})
	return file_runtime_broker_pulsar_v1_pulsar_proto_rawDescData
}

var file_runtime_broker_pulsar_v1_pulsar_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_runtime_broker_pulsar_v1_pulsar_proto_goTypes = []any{
	(*PulsarConfig)(nil), // 0: runtime.broker.pulsar.v1.PulsarConfig
}
var file_runtime_broker_pulsar_v1_pulsar_proto_depIdxs = []int32{
...
func init() { file_runtime_broker_pulsar_v1_pulsar_proto_init() }
func file_runtime_broker_pulsar_v1_pulsar_proto_init() {
	if File_runtime_broker_pulsar_v1_pulsar_proto != nil {
		return
	}
	file_runtime_broker_pulsar_v1_pulsar_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runtime_broker_pulsar_v1_pulsar_proto_rawDesc), len(file_runtime_broker_pulsar_v1_pulsar_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runtime_broker_pulsar_v1_pulsar_proto_goTypes,
		DependencyIndexes: file_runtime_broker_pulsar_v1_pulsar_proto_depIdxs,
		MessageInfos:      file_runtime_broker_pulsar_v1_pulsar_proto_msgTypes,
	}.Build()
	File_runtime_broker_pulsar_v1_pulsar_proto = out.File
	file_runtime_broker_pulsar_v1_pulsar_proto_goTypes = nil
	file_runtime_broker_pulsar_v1_pulsar_proto_depIdxs = nil
}
