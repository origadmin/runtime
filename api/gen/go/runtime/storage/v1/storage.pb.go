...
// 	protoc        (unknown)
// source: runtime/storage/v1/storage.proto
...
func (x *Migration) Reset() {
	*x = Migration{}
	mi := &file_runtime_storage_v1_storage_proto_msgTypes[0]
...
func (*Migration) Descriptor() ([]byte, []int) {
	return file_runtime_storage_v1_storage_proto_rawDescGZIP(), []int{0}
}
...
func (x *Database) Reset() {
	*x = Database{}
	mi := &file_runtime_storage_v1_storage_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Database) Descriptor() ([]byte, []int) {
	return file_runtime_storage_v1_storage_proto_rawDescGZIP(), []int{1}
}
...
func (x *Redis) Reset() {
	*x = Redis{}
	mi := &file_runtime_storage_v1_storage_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Redis) Descriptor() ([]byte, []int) {
	return file_runtime_storage_v1_storage_proto_rawDescGZIP(), []int{2}
}
...
func (x *Memcached) Reset() {
	*x = Memcached{}
	mi := &file_runtime_storage_v1_storage_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Memcached) Descriptor() ([]byte, []int) {
	return file_runtime_storage_v1_storage_proto_rawDescGZIP(), []int{3}
}
...
func (x *Memory) Reset() {
	*x = Memory{}
	mi := &file_runtime_storage_v1_storage_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Memory) Descriptor() ([]byte, []int) {
	return file_runtime_storage_v1_storage_proto_rawDescGZIP(), []int{4}
}
...
func (x *Mongo) Reset() {
	*x = Mongo{}
	mi := &file_runtime_storage_v1_storage_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Mongo) Descriptor() ([]byte, []int) {
	return file_runtime_storage_v1_storage_proto_rawDescGZIP(), []int{5}
}
...
func (x *Cache) Reset() {
	*x = Cache{}
	mi := &file_runtime_storage_v1_storage_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Cache) Descriptor() ([]byte, []int) {
	return file_runtime_storage_v1_storage_proto_rawDescGZIP(), []int{6}
}
...
func (x *Oss) Reset() {
	*x = Oss{}
	mi := &file_runtime_storage_v1_storage_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Oss) Descriptor() ([]byte, []int) {
	return file_runtime_storage_v1_storage_proto_rawDescGZIP(), []int{7}
}
...
func (x *FileLocal) Reset() {
	*x = FileLocal{}
	mi := &file_runtime_storage_v1_storage_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FileLocal) Descriptor() ([]byte, []int) {
	return file_runtime_storage_v1_storage_proto_rawDescGZIP(), []int{8}
}
...
func (x *FileStore) Reset() {
	*x = FileStore{}
	mi := &file_runtime_storage_v1_storage_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FileStore) Descriptor() ([]byte, []int) {
	return file_runtime_storage_v1_storage_proto_rawDescGZIP(), []int{9}
}
...
func (x *Storage) Reset() {
	*x = Storage{}
	mi := &file_runtime_storage_v1_storage_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Storage) Descriptor() ([]byte, []int) {
	return file_runtime_storage_v1_storage_proto_rawDescGZIP(), []int{10}
}
...
const file_runtime_storage_v1_storage_proto_rawDesc = "" +
	"\n" +
	" runtime/storage/v1/storage.proto\x12\x12runtime.storage.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x17validate/validate.proto\"\xfb\x01\n" +
	"\tMigration\x12;\n" +
	...
	"\x04mode\x18\x05 \x01(\tB\x14\xbaG\x11\x92\x02\x0emigration modeR\x04mode\"\xce\a\n" +
	"\bDatabase\x129\n" +
	...
	"\x06source\x18\x03 \x01(\tB\x1c\xbaG\x19\x92\x02\x16data source dsn stringR\x06source\x12Q\n" +
	"\tmigration\x18\n" +
	" \x01(\v2\x1d.runtime.storage.v1.MigrationB\x14\xbaG\x11\x92\x02\x0edata migrationR\tmigration\x12>\n" +
	...
	"\x0fconnect_timeout\x18\b \x01(\x03B/\xfaB\x04\"\x02(\x00\xbaG%\x92\x02\"Connection timeout in millisecondsR\x0fconnect_timeout\"\xee\x03\n" +
	"\x05Cache\x12T\n" +
	...
	"cache nameR\x04name\x12`\n" +
	"\tmemcached\x18\n" +
	" \x01(\v2\x1d.runtime.storage.v1.MemcachedB#\xbaG \x92\x02\x1dmemcached cache configurationR\tmemcached\x12T\n" +
	"\x06memory\x18\v \x01(\v2\x1a.runtime.storage.v1.MemoryB \xbaG\x1d\x92\x02\x1amemory cache configurationR\x06memory\x12P\n" +
	"\x05redis\x18\f \x01(\v2\x19.runtime.storage.v1.RedisB\x1f\xbaG\x1c\x92\x02\x19redis cache configurationR\x05redis\x12_\n" +
	...
	"\tFileLocal\x12(\n" +
	"\x04root\x18\x01 \x01(\tB\x14\xbaG\x11\x92\x02\x0eroot directoryR\x04root\"\xda\x02\n" +
	"\tFileStore\x12E\n" +
	"\x06driver\x18\x01 \x01(\tB-\xfaB\x0er\fR\x05localR\x03oss\xbaG\x19\x92\x02\x16file store driver nameR\x06driver\x12_\n" +
	"\x05local\x18\x02 \x01(\v2\x1d.runtime.storage.v1.FileLocalB%\xbaG\"\x92\x02\x1flocal file system configurationH\x00R\x05local\x88\x01\x01\x12X\n" +
	"\x03oss\x18\x03 \x01(\v2\x17.runtime.storage.v1.OssB(\xbaG%\x92\x02\"cloud object storage configurationH\x01R\x03oss\x88\x01\x01\x129\n" +
	"\n" +
	...
	"\aStorage\x12x\n" +
	"\n" +
	"filestores\x18\x01 \x03(\v2+.runtime.storage.v1.Storage.FilestoresEntryB+\xbaG(\x92\x02%map of named FileStore configurationsR\n" +
	"filestores\x12h\n" +
	"\x06caches\x18\x02 \x03(\v2'.runtime.storage.v1.Storage.CachesEntryB'\xbaG$\x92\x02!map of named Cache configurationsR\x06caches\x12t\n" +
	"\tdatabases\x18\x03 \x03(\v2*.runtime.storage.v1.Storage.DatabasesEntryB*\xbaG'\x92\x02$map of named Database configurationsR\tdatabases\x12O\n" +
	...
	"\x10default_database\x18\x06 \x01(\tB\x1b\xbaG\x18\x92\x02\x15default database nameH\x02R\x10default_database\x88\x01\x01\x1a\\\n" +
	"\x0fFilestoresEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x123\n" +
	"\x05value\x18\x02 \x01(\v2\x1d.runtime.storage.v1.FileStoreR\x05value:\x028\x01\x1aT\n" +
	"\vCachesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12/\n" +
	"\x05value\x18\x02 \x01(\v2\x19.runtime.storage.v1.CacheR\x05value:\x028\x01\x1aZ\n" +
	"\x0eDatabasesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x122\n" +
	"\x05value\x18\x02 \x01(\v2\x1c.runtime.storage.v1.DatabaseR\x05value:\x028\x01B\x14\n" +
	"\x12_default_filestoreB\x10\n" +
	"\x0e_default_cacheB\x13\n" +
	"\x11_default_databaseB\xd9\x01\n" +
	"\x16com.runtime.storage.v1B\fStorageProtoP\x01ZDgithub.com/origadmin/runtime/api/gen/go/runtime/storage/v1;storagev1\xf8\x01\x01\xa2\x02\x03RSX\xaa\x02\x12Runtime.Storage.V1\xca\x02\x12Runtime\\Storage\\V1\xe2\x02\x1eRuntime\\Storage\\V1\\GPBMetadata\xea\x02\x14Runtime::Storage::V1b\x06proto3"

var (
	file_runtime_storage_v1_storage_proto_rawDescOnce sync.Once
	file_runtime_storage_v1_storage_proto_rawDescData []byte
)

func file_runtime_storage_v1_storage_proto_rawDescGZIP() []byte {
	file_runtime_storage_v1_storage_proto_rawDescOnce.Do(func() {
		file_runtime_storage_v1_storage_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_runtime_storage_v1_storage_proto_rawDesc), len(file_runtime_storage_v1_storage_proto_rawDesc)))
	})
	return file_runtime_storage_v1_storage_proto_rawDescData
}

var file_runtime_storage_v1_storage_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_runtime_storage_v1_storage_proto_goTypes = []any{
	(*Migration)(nil), // 0: runtime.storage.v1.Migration
	(*Database)(nil),  // 1: runtime.storage.v1.Database
	(*Redis)(nil),     // 2: runtime.storage.v1.Redis
	(*Memcached)(nil), // 3: runtime.storage.v1.Memcached
	(*Memory)(nil),    // 4: runtime.storage.v1.Memory
	(*Mongo)(nil),     // 5: runtime.storage.v1.Mongo
	(*Cache)(nil),     // 6: runtime.storage.v1.Cache
	(*Oss)(nil),       // 7: runtime.storage.v1.Oss
	(*FileLocal)(nil), // 8: runtime.storage.v1.FileLocal
	(*FileStore)(nil), // 9: runtime.storage.v1.FileStore
	(*Storage)(nil),   // 10: runtime.storage.v1.Storage
	nil,               // 11: runtime.storage.v1.Storage.FilestoresEntry
	nil,               // 12: runtime.storage.v1.Storage.CachesEntry
	nil,               // 13: runtime.storage.v1.Storage.DatabasesEntry
}
var file_runtime_storage_v1_storage_proto_depIdxs = []int32{
	0,  // 0: runtime.storage.v1.Database.migration:type_name -> runtime.storage.v1.Migration
	3,  // 1: runtime.storage.v1.Cache.memcached:type_name -> runtime.storage.v1.Memcached
	4,  // 2: runtime.storage.v1.Cache.memory:type_name -> runtime.storage.v1.Memory
	2,  // 3: runtime.storage.v1.Cache.redis:type_name -> runtime.storage.v1.Redis
	8,  // 4: runtime.storage.v1.FileStore.local:type_name -> runtime.storage.v1.FileLocal
	7,  // 5: runtime.storage.v1.FileStore.oss:type_name -> runtime.storage.v1.Oss
	11, // 6: runtime.storage.v1.Storage.filestores:type_name -> runtime.storage.v1.Storage.FilestoresEntry
	12, // 7: runtime.storage.v1.Storage.caches:type_name -> runtime.storage.v1.Storage.CachesEntry
	13, // 8: runtime.storage.v1.Storage.databases:type_name -> runtime.storage.v1.Storage.DatabasesEntry
	9,  // 9: runtime.storage.v1.Storage.FilestoresEntry.value:type_name -> runtime.storage.v1.FileStore
	6,  // 10: runtime.storage.v1.Storage.CachesEntry.value:type_name -> runtime.storage.v1.Cache
	1,  // 11: runtime.storage.v1.Storage.DatabasesEntry.value:type_name -> runtime.storage.v1.Database
...
func init() { file_runtime_storage_v1_storage_proto_init() }
func file_runtime_storage_v1_storage_proto_init() {
	if File_runtime_storage_v1_storage_proto != nil {
		return
	}
	file_runtime_storage_v1_storage_proto_msgTypes[9].OneofWrappers = []any{}
	file_runtime_storage_v1_storage_proto_msgTypes[10].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_runtime_storage_v1_storage_proto_rawDesc), len(file_runtime_storage_v1_storage_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_runtime_storage_v1_storage_proto_goTypes,
		DependencyIndexes: file_runtime_storage_v1_storage_proto_depIdxs,
		MessageInfos:      file_runtime_storage_v1_storage_proto_msgTypes,
	}.Build()
	File_runtime_storage_v1_storage_proto = out.File
	file_runtime_storage_v1_storage_proto_goTypes = nil
	file_runtime_storage_v1_storage_proto_depIdxs = nil
}
