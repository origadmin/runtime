...
// 	protoc        (unknown)
// source: security/transport/v1/tls.proto
...
func (x *TLSConfig) Reset() {
	*x = TLSConfig{}
	mi := &file_security_transport_v1_tls_proto_msgTypes[0]
...
func (*TLSConfig) Descriptor() ([]byte, []int) {
	return file_security_transport_v1_tls_proto_rawDescGZIP(), []int{0}
}
...
func (x *FileConfig) Reset() {
	*x = FileConfig{}
	mi := &file_security_transport_v1_tls_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FileConfig) Descriptor() ([]byte, []int) {
	return file_security_transport_v1_tls_proto_rawDescGZIP(), []int{1}
}
...
func (x *PEMConfig) Reset() {
	*x = PEMConfig{}
	mi := &file_security_transport_v1_tls_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PEMConfig) Descriptor() ([]byte, []int) {
	return file_security_transport_v1_tls_proto_rawDescGZIP(), []int{2}
}
...
var File_security_transport_v1_tls_proto protoreflect.FileDescriptor
...
const file_security_transport_v1_tls_proto_rawDesc = "" +
	...
	"\x02ca\x18\x03 \x01(\fR\x02caB\xe9\x01\n" +
	"\x19com.security.transport.v1B\bTlsProtoP\x01ZIgithub.com/origadmin/runtime/api/gen/go/security/transport/v1;transportv1\xf8\x01\x01\xa2\x02\x03STX\xaa\x02\x15Security.Transport.V1\xca\x02\x15Security\\Transport\\V1\xe2\x02!Security\\Transport\\V1\\GPBMetadata\xea\x02\x17Security::Transport::V1b\x06proto3"

var (
	file_security_transport_v1_tls_proto_rawDescOnce sync.Once
	file_security_transport_v1_tls_proto_rawDescData []byte
)

func file_security_transport_v1_tls_proto_rawDescGZIP() []byte {
	file_security_transport_v1_tls_proto_rawDescOnce.Do(func() {
		file_security_transport_v1_tls_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_security_transport_v1_tls_proto_rawDesc), len(file_security_transport_v1_tls_proto_rawDesc)))
	})
	return file_security_transport_v1_tls_proto_rawDescData
}

var file_security_transport_v1_tls_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_security_transport_v1_tls_proto_goTypes = []any{
	(*TLSConfig)(nil),  // 0: security.transport.v1.TLSConfig
	(*FileConfig)(nil), // 1: security.transport.v1.FileConfig
	(*PEMConfig)(nil),  // 2: security.transport.v1.PEMConfig
}
var file_security_transport_v1_tls_proto_depIdxs = []int32{
	1, // 0: security.transport.v1.TLSConfig.file:type_name -> security.transport.v1.FileConfig
	2, // 1: security.transport.v1.TLSConfig.pem:type_name -> security.transport.v1.PEMConfig
...
func init() { file_security_transport_v1_tls_proto_init() }
func file_security_transport_v1_tls_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_security_transport_v1_tls_proto_rawDesc), len(file_security_transport_v1_tls_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_security_transport_v1_tls_proto_goTypes,
		DependencyIndexes: file_security_transport_v1_tls_proto_depIdxs,
		MessageInfos:      file_security_transport_v1_tls_proto_msgTypes,
	}.Build()
	File_security_transport_v1_tls_proto = out.File
	file_security_transport_v1_tls_proto_goTypes = nil
	file_security_transport_v1_tls_proto_depIdxs = nil
}
