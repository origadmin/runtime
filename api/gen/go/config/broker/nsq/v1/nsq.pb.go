...
// 	protoc        (unknown)
// source: config/broker/nsq/v1/nsq.proto
...
func (x *NsqConfig) Reset() {
	*x = NsqConfig{}
	mi := &file_config_broker_nsq_v1_nsq_proto_msgTypes[0]
...
func (*NsqConfig) Descriptor() ([]byte, []int) {
	return file_config_broker_nsq_v1_nsq_proto_rawDescGZIP(), []int{0}
}
...
var File_config_broker_nsq_v1_nsq_proto protoreflect.FileDescriptor

const file_config_broker_nsq_v1_nsq_proto_rawDesc = "" +
	"\n" +
	"\x1econfig/broker/nsq/v1/nsq.proto\x12\x14config.broker.nsq.v1\x1a$gnostic/openapi/v3/annotations.proto\"\xa6\t\n" +
	"\tNsqConfig\x12]\n" +
	...
	"\x19_tls_insecure_skip_verifyB\xdb\x01\n" +
	"\x18com.config.broker.nsq.v1B\bNsqProtoP\x01ZBgithub.com/origadmin/runtime/api/gen/go/config/broker/nsq/v1;nsqv1\xa2\x02\x03CBN\xaa\x02\x14Config.Broker.Nsq.V1\xca\x02\x14Config\\Broker\\Nsq\\V1\xe2\x02 Config\\Broker\\Nsq\\V1\\GPBMetadata\xea\x02\x17Config::Broker::Nsq::V1b\x06proto3"

var (
	file_config_broker_nsq_v1_nsq_proto_rawDescOnce sync.Once
	file_config_broker_nsq_v1_nsq_proto_rawDescData []byte
)

func file_config_broker_nsq_v1_nsq_proto_rawDescGZIP() []byte {
	file_config_broker_nsq_v1_nsq_proto_rawDescOnce.Do(func() {
		file_config_broker_nsq_v1_nsq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_broker_nsq_v1_nsq_proto_rawDesc), len(file_config_broker_nsq_v1_nsq_proto_rawDesc)))
	})
	return file_config_broker_nsq_v1_nsq_proto_rawDescData
}

var file_config_broker_nsq_v1_nsq_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_config_broker_nsq_v1_nsq_proto_goTypes = []any{
	(*NsqConfig)(nil), // 0: config.broker.nsq.v1.NsqConfig
}
var file_config_broker_nsq_v1_nsq_proto_depIdxs = []int32{
...
func init() { file_config_broker_nsq_v1_nsq_proto_init() }
func file_config_broker_nsq_v1_nsq_proto_init() {
	if File_config_broker_nsq_v1_nsq_proto != nil {
		return
	}
	file_config_broker_nsq_v1_nsq_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_broker_nsq_v1_nsq_proto_rawDesc), len(file_config_broker_nsq_v1_nsq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_broker_nsq_v1_nsq_proto_goTypes,
		DependencyIndexes: file_config_broker_nsq_v1_nsq_proto_depIdxs,
		MessageInfos:      file_config_broker_nsq_v1_nsq_proto_msgTypes,
	}.Build()
	File_config_broker_nsq_v1_nsq_proto = out.File
	file_config_broker_nsq_v1_nsq_proto_goTypes = nil
	file_config_broker_nsq_v1_nsq_proto_depIdxs = nil
}
