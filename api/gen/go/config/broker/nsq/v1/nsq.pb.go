...
const file_config_broker_nsq_v1_nsq_proto_rawDesc = "" +
	...
	"\x19_tls_insecure_skip_verifyB\x9b\x02\n" +
	"$com.runtime.api.config.broker.nsq.v1B\bNsqProtoP\x01ZBgithub.com/origadmin/runtime/api/gen/go/config/broker/nsq/v1;nsqv1\xa2\x02\x05RACBN\xaa\x02 Runtime.Api.Config.Broker.Nsq.V1\xca\x02 Runtime\\Api\\Config\\Broker\\Nsq\\V1\xe2\x02,Runtime\\Api\\Config\\Broker\\Nsq\\V1\\GPBMetadata\xea\x02%Runtime::Api::Config::Broker::Nsq::V1b\x06proto3"
...
var file_config_broker_nsq_v1_nsq_proto_goTypes = []any{
	(*NsqConfig)(nil), // 0: runtime.api.config.broker.nsq.v1.NsqConfig
}
