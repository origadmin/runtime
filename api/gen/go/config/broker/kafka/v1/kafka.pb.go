...
const file_config_broker_kafka_v1_kafka_proto_rawDesc = "" +
	...
	"\x05_acksB\x13\n" +
	"\x11_compression_typeB\xab\x02\n" +
	"&com.runtime.api.config.broker.kafka.v1B\n" +
	"KafkaProtoP\x01ZFgithub.com/origadmin/runtime/api/gen/go/config/broker/kafka/v1;kafkav1\xa2\x02\x05RACBK\xaa\x02\"Runtime.Api.Config.Broker.Kafka.V1\xca\x02\"Runtime\\Api\\Config\\Broker\\Kafka\\V1\xe2\x02.Runtime\\Api\\Config\\Broker\\Kafka\\V1\\GPBMetadata\xea\x02'Runtime::Api::Config::Broker::Kafka::V1b\x06proto3"
...
var file_config_broker_kafka_v1_kafka_proto_goTypes = []any{
	(*KafkaConfig)(nil), // 0: runtime.api.config.broker.kafka.v1.KafkaConfig
}
