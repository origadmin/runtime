...
const file_config_broker_redis_mq_v1_redis_mq_proto_rawDesc = "" +
	"\n" +
	"(config/broker/redis_mq/v1/redis_mq.proto\x12\x19config.broker.redis_mq.v1\x1a$gnostic/openapi/v3/annotations.proto\"\xcd\b\n" +
	"\rRedisMqConfig\x12G\n" +
	...
	"\x19_tls_insecure_skip_verifyB\xfd\x01\n" +
	"\x1dcom.config.broker.redis_mq.v1B\fRedisMqProtoP\x01ZKgithub.com/origadmin/runtime/api/gen/go/config/broker/redis_mq/v1;redismqv1\xa2\x02\x03CBR\xaa\x02\x18Config.Broker.RedisMq.V1\xca\x02\x18Config\\Broker\\RedisMq\\V1\xe2\x02$Config\\Broker\\RedisMq\\V1\\GPBMetadata\xea\x02\x1bConfig::Broker::RedisMq::V1b\x06proto3"
...
var file_config_broker_redis_mq_v1_redis_mq_proto_goTypes = []any{
	(*RedisMqConfig)(nil), // 0: config.broker.redis_mq.v1.RedisMqConfig
}
