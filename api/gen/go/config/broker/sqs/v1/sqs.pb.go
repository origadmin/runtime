...
const file_config_broker_sqs_v1_sqs_proto_rawDesc = "" +
	...
	"\x15_long_polling_enabledB\x9b\x02\n" +
	"$com.runtime.api.config.broker.sqs.v1B\bSqsProtoP\x01ZBgithub.com/origadmin/runtime/api/gen/go/config/broker/sqs/v1;sqsv1\xa2\x02\x05RACBS\xaa\x02 Runtime.Api.Config.Broker.Sqs.V1\xca\x02 Runtime\\Api\\Config\\Broker\\Sqs\\V1\xe2\x02,Runtime\\Api\\Config\\Broker\\Sqs\\V1\\GPBMetadata\xea\x02%Runtime::Api::Config::Broker::Sqs::V1b\x06proto3"
...
var file_config_broker_sqs_v1_sqs_proto_goTypes = []any{
	(*SqsConfig)(nil), // 0: runtime.api.config.broker.sqs.v1.SqsConfig
}
