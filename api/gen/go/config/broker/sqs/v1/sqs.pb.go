...
func (x *SqsConfig) Reset() {
	*x = SqsConfig{}
	mi := &file_config_broker_sqs_v1_sqs_proto_msgTypes[0]
...
func (*SqsConfig) Descriptor() ([]byte, []int) {
	return file_config_broker_sqs_v1_sqs_proto_rawDescGZIP(), []int{0}
}
...
var File_config_broker_sqs_v1_sqs_proto protoreflect.FileDescriptor

const file_config_broker_sqs_v1_sqs_proto_rawDesc = "" +
	"\n" +
	"\x1econfig/broker/sqs/v1/sqs.proto\x12\x14config.broker.sqs.v1\x1a$gnostic/openapi/v3/annotations.proto\"\xc6\a\n" +
	"\tSqsConfig\x12=\n" +
	...
	"\x15_long_polling_enabledB\xdb\x01\n" +
	"\x18com.config.broker.sqs.v1B\bSqsProtoP\x01ZBgithub.com/origadmin/runtime/api/gen/go/config/broker/sqs/v1;sqsv1\xa2\x02\x03CBS\xaa\x02\x14Config.Broker.Sqs.V1\xca\x02\x14Config\\Broker\\Sqs\\V1\xe2\x02 Config\\Broker\\Sqs\\V1\\GPBMetadata\xea\x02\x17Config::Broker::Sqs::V1b\x06proto3"

var (
	file_config_broker_sqs_v1_sqs_proto_rawDescOnce sync.Once
	file_config_broker_sqs_v1_sqs_proto_rawDescData []byte
)

func file_config_broker_sqs_v1_sqs_proto_rawDescGZIP() []byte {
	file_config_broker_sqs_v1_sqs_proto_rawDescOnce.Do(func() {
		file_config_broker_sqs_v1_sqs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_broker_sqs_v1_sqs_proto_rawDesc), len(file_config_broker_sqs_v1_sqs_proto_rawDesc)))
	})
	return file_config_broker_sqs_v1_sqs_proto_rawDescData
}

var file_config_broker_sqs_v1_sqs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_config_broker_sqs_v1_sqs_proto_goTypes = []any{
	(*SqsConfig)(nil), // 0: config.broker.sqs.v1.SqsConfig
}
var file_config_broker_sqs_v1_sqs_proto_depIdxs = []int32{
...
func init() { file_config_broker_sqs_v1_sqs_proto_init() }
func file_config_broker_sqs_v1_sqs_proto_init() {
	if File_config_broker_sqs_v1_sqs_proto != nil {
		return
	}
	file_config_broker_sqs_v1_sqs_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_broker_sqs_v1_sqs_proto_rawDesc), len(file_config_broker_sqs_v1_sqs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_broker_sqs_v1_sqs_proto_goTypes,
		DependencyIndexes: file_config_broker_sqs_v1_sqs_proto_depIdxs,
		MessageInfos:      file_config_broker_sqs_v1_sqs_proto_msgTypes,
	}.Build()
	File_config_broker_sqs_v1_sqs_proto = out.File
	file_config_broker_sqs_v1_sqs_proto_goTypes = nil
	file_config_broker_sqs_v1_sqs_proto_depIdxs = nil
}
