...
const file_config_broker_stomp_v1_stomp_proto_rawDesc = "" +
	...
	"\x16_heartbeat_interval_msB\xab\x02\n" +
	"&com.runtime.api.config.broker.stomp.v1B\n" +
	"StompProtoP\x01ZFgithub.com/origadmin/runtime/api/gen/go/config/broker/stomp/v1;stompv1\xa2\x02\x05RACBS\xaa\x02\"Runtime.Api.Config.Broker.Stomp.V1\xca\x02\"Runtime\\Api\\Config\\Broker\\Stomp\\V1\xe2\x02.Runtime\\Api\\Config\\Broker\\Stomp\\V1\\GPBMetadata\xea\x02'Runtime::Api::Config::Broker::Stomp::V1b\x06proto3"
...
var file_config_broker_stomp_v1_stomp_proto_goTypes = []any{
	(*StompConfig)(nil), // 0: runtime.api.config.broker.stomp.v1.StompConfig
}
