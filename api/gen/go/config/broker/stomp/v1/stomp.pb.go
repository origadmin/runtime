...
func (x *StompConfig) Reset() {
	*x = StompConfig{}
	mi := &file_config_broker_stomp_v1_stomp_proto_msgTypes[0]
...
func (*StompConfig) Descriptor() ([]byte, []int) {
	return file_config_broker_stomp_v1_stomp_proto_rawDescGZIP(), []int{0}
}
...
var File_config_broker_stomp_v1_stomp_proto protoreflect.FileDescriptor

const file_config_broker_stomp_v1_stomp_proto_rawDesc = "" +
	"\n" +
	"\"config/broker/stomp/v1/stomp.proto\x12\x16config.broker.stomp.v1\x1a$gnostic/openapi/v3/annotations.proto\"\x91\b\n" +
	"\vStompConfig\x12O\n" +
	...
	"\x16_heartbeat_interval_msB\xeb\x01\n" +
	"\x1acom.config.broker.stomp.v1B\n" +
	"StompProtoP\x01ZFgithub.com/origadmin/runtime/api/gen/go/config/broker/stomp/v1;stompv1\xa2\x02\x03CBS\xaa\x02\x16Config.Broker.Stomp.V1\xca\x02\x16Config\\Broker\\Stomp\\V1\xe2\x02\"Config\\Broker\\Stomp\\V1\\GPBMetadata\xea\x02\x19Config::Broker::Stomp::V1b\x06proto3"

var (
	file_config_broker_stomp_v1_stomp_proto_rawDescOnce sync.Once
	file_config_broker_stomp_v1_stomp_proto_rawDescData []byte
)

func file_config_broker_stomp_v1_stomp_proto_rawDescGZIP() []byte {
	file_config_broker_stomp_v1_stomp_proto_rawDescOnce.Do(func() {
		file_config_broker_stomp_v1_stomp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_broker_stomp_v1_stomp_proto_rawDesc), len(file_config_broker_stomp_v1_stomp_proto_rawDesc)))
	})
	return file_config_broker_stomp_v1_stomp_proto_rawDescData
}

var file_config_broker_stomp_v1_stomp_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_config_broker_stomp_v1_stomp_proto_goTypes = []any{
	(*StompConfig)(nil), // 0: config.broker.stomp.v1.StompConfig
}
var file_config_broker_stomp_v1_stomp_proto_depIdxs = []int32{
...
func init() { file_config_broker_stomp_v1_stomp_proto_init() }
func file_config_broker_stomp_v1_stomp_proto_init() {
	if File_config_broker_stomp_v1_stomp_proto != nil {
		return
	}
	file_config_broker_stomp_v1_stomp_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_broker_stomp_v1_stomp_proto_rawDesc), len(file_config_broker_stomp_v1_stomp_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_broker_stomp_v1_stomp_proto_goTypes,
		DependencyIndexes: file_config_broker_stomp_v1_stomp_proto_depIdxs,
		MessageInfos:      file_config_broker_stomp_v1_stomp_proto_msgTypes,
	}.Build()
	File_config_broker_stomp_v1_stomp_proto = out.File
	file_config_broker_stomp_v1_stomp_proto_goTypes = nil
	file_config_broker_stomp_v1_stomp_proto_depIdxs = nil
}
