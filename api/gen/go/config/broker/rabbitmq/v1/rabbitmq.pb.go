...
const file_config_broker_rabbitmq_v1_rabbitmq_proto_rawDesc = "" +
	...
	"\v_qos_globalB\v\n" +
	"\t_auto_ackB\x16\n" +
	"\x14_persistent_messagesB\xc3\x02\n" +
	")com.runtime.api.config.broker.rabbitmq.v1B\rRabbitmqProtoP\x01ZLgithub.com/origadmin/runtime/api/gen/go/config/broker/rabbitmq/v1;rabbitmqv1\xa2\x02\x05RACBR\xaa\x02%Runtime.Api.Config.Broker.Rabbitmq.V1\xca\x02%Runtime\\Api\\Config\\Broker\\Rabbitmq\\V1\xe2\x021Runtime\\Api\\Config\\Broker\\Rabbitmq\\V1\\GPBMetadata\xea\x02*Runtime::Api::Config::Broker::Rabbitmq::V1b\x06proto3"
...
var file_config_broker_rabbitmq_v1_rabbitmq_proto_goTypes = []any{
	(*RabbitMQConfig)(nil), // 0: runtime.api.config.broker.rabbitmq.v1.RabbitMQConfig
}
