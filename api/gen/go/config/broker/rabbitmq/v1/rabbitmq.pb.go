...
// 	protoc        (unknown)
// source: config/broker/rabbitmq/v1/rabbitmq.proto
...
func (x *RabbitMQConfig) Reset() {
	*x = RabbitMQConfig{}
	mi := &file_config_broker_rabbitmq_v1_rabbitmq_proto_msgTypes[0]
...
func (*RabbitMQConfig) Descriptor() ([]byte, []int) {
	return file_config_broker_rabbitmq_v1_rabbitmq_proto_rawDescGZIP(), []int{0}
}
...
var File_config_broker_rabbitmq_v1_rabbitmq_proto protoreflect.FileDescriptor

const file_config_broker_rabbitmq_v1_rabbitmq_proto_rawDesc = "" +
	"\n" +
	"(config/broker/rabbitmq/v1/rabbitmq.proto\x12\x19config.broker.rabbitmq.v1\x1a$gnostic/openapi/v3/annotations.proto\"\xd9\f\n" +
	...
	"\v_qos_globalB\v\n" +
	"\t_auto_ackB\x16\n" +
	"\x14_persistent_messagesB\x83\x02\n" +
	"\x1dcom.config.broker.rabbitmq.v1B\rRabbitmqProtoP\x01ZLgithub.com/origadmin/runtime/api/gen/go/config/broker/rabbitmq/v1;rabbitmqv1\xa2\x02\x03CBR\xaa\x02\x19Config.Broker.Rabbitmq.V1\xca\x02\x19Config\\Broker\\Rabbitmq\\V1\xe2\x02%Config\\Broker\\Rabbitmq\\V1\\GPBMetadata\xea\x02\x1cConfig::Broker::Rabbitmq::V1b\x06proto3"

var (
	file_config_broker_rabbitmq_v1_rabbitmq_proto_rawDescOnce sync.Once
	file_config_broker_rabbitmq_v1_rabbitmq_proto_rawDescData []byte
)

func file_config_broker_rabbitmq_v1_rabbitmq_proto_rawDescGZIP() []byte {
	file_config_broker_rabbitmq_v1_rabbitmq_proto_rawDescOnce.Do(func() {
		file_config_broker_rabbitmq_v1_rabbitmq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_broker_rabbitmq_v1_rabbitmq_proto_rawDesc), len(file_config_broker_rabbitmq_v1_rabbitmq_proto_rawDesc)))
	})
	return file_config_broker_rabbitmq_v1_rabbitmq_proto_rawDescData
}

var file_config_broker_rabbitmq_v1_rabbitmq_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_config_broker_rabbitmq_v1_rabbitmq_proto_goTypes = []any{
	(*RabbitMQConfig)(nil), // 0: config.broker.rabbitmq.v1.RabbitMQConfig
}
var file_config_broker_rabbitmq_v1_rabbitmq_proto_depIdxs = []int32{
...
func init() { file_config_broker_rabbitmq_v1_rabbitmq_proto_init() }
func file_config_broker_rabbitmq_v1_rabbitmq_proto_init() {
	if File_config_broker_rabbitmq_v1_rabbitmq_proto != nil {
		return
	}
	file_config_broker_rabbitmq_v1_rabbitmq_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_broker_rabbitmq_v1_rabbitmq_proto_rawDesc), len(file_config_broker_rabbitmq_v1_rabbitmq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_broker_rabbitmq_v1_rabbitmq_proto_goTypes,
		DependencyIndexes: file_config_broker_rabbitmq_v1_rabbitmq_proto_depIdxs,
		MessageInfos:      file_config_broker_rabbitmq_v1_rabbitmq_proto_msgTypes,
	}.Build()
	File_config_broker_rabbitmq_v1_rabbitmq_proto = out.File
	file_config_broker_rabbitmq_v1_rabbitmq_proto_goTypes = nil
	file_config_broker_rabbitmq_v1_rabbitmq_proto_depIdxs = nil
}
