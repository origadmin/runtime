...
const file_config_broker_pulsar_v1_pulsar_proto_rawDesc = "" +
	"\n" +
	"$config/broker/pulsar/v1/pulsar.proto\x12\x17config.broker.pulsar.v1\x1a$gnostic/openapi/v3/annotations.proto\"\xbc\t\n" +
	"\fPulsarConfig\x12c\n" +
	...
	"\x15_max_pending_messagesB\xf3\x01\n" +
	"\x1bcom.config.broker.pulsar.v1B\vPulsarProtoP\x01ZHgithub.com/origadmin/runtime/api/gen/go/config/broker/pulsar/v1;pulsarv1\xa2\x02\x03CBP\xaa\x02\x17Config.Broker.Pulsar.V1\xca\x02\x17Config\\Broker\\Pulsar\\V1\xe2\x02#Config\\Broker\\Pulsar\\V1\\GPBMetadata\xea\x02\x1aConfig::Broker::Pulsar::V1b\x06proto3"
...
var file_config_broker_pulsar_v1_pulsar_proto_goTypes = []any{
	(*PulsarConfig)(nil), // 0: config.broker.pulsar.v1.PulsarConfig
}
