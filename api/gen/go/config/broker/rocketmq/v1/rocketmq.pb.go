...
const file_config_broker_rocketmq_v1_rocketmq_proto_rawDesc = "" +
	...
	"\f_tls_enabledB\xc3\x02\n" +
	")com.runtime.api.config.broker.rocketmq.v1B\rRocketmqProtoP\x01ZLgithub.com/origadmin/runtime/api/gen/go/config/broker/rocketmq/v1;rocketmqv1\xa2\x02\x05RACBR\xaa\x02%Runtime.Api.Config.Broker.Rocketmq.V1\xca\x02%Runtime\\Api\\Config\\Broker\\Rocketmq\\V1\xe2\x021Runtime\\Api\\Config\\Broker\\Rocketmq\\V1\\GPBMetadata\xea\x02*Runtime::Api::Config::Broker::Rocketmq::V1b\x06proto3"
...
var file_config_broker_rocketmq_v1_rocketmq_proto_goTypes = []any{
	(*RocketMQConfig)(nil), // 0: runtime.api.config.broker.rocketmq.v1.RocketMQConfig
}
