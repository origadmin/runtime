...
func (x *RocketMQConfig) Reset() {
	*x = RocketMQConfig{}
	mi := &file_config_broker_rocketmq_v1_rocketmq_proto_msgTypes[0]
...
func (*RocketMQConfig) Descriptor() ([]byte, []int) {
	return file_config_broker_rocketmq_v1_rocketmq_proto_rawDescGZIP(), []int{0}
}
...
var File_config_broker_rocketmq_v1_rocketmq_proto protoreflect.FileDescriptor

const file_config_broker_rocketmq_v1_rocketmq_proto_rawDesc = "" +
	"\n" +
	"(config/broker/rocketmq/v1/rocketmq.proto\x12\x19config.broker.rocketmq.v1\x1a$gnostic/openapi/v3/annotations.proto\"\xf1\a\n" +
	...
	"\f_tls_enabledB\x83\x02\n" +
	"\x1dcom.config.broker.rocketmq.v1B\rRocketmqProtoP\x01ZLgithub.com/origadmin/runtime/api/gen/go/config/broker/rocketmq/v1;rocketmqv1\xa2\x02\x03CBR\xaa\x02\x19Config.Broker.Rocketmq.V1\xca\x02\x19Config\\Broker\\Rocketmq\\V1\xe2\x02%Config\\Broker\\Rocketmq\\V1\\GPBMetadata\xea\x02\x1cConfig::Broker::Rocketmq::V1b\x06proto3"

var (
	file_config_broker_rocketmq_v1_rocketmq_proto_rawDescOnce sync.Once
	file_config_broker_rocketmq_v1_rocketmq_proto_rawDescData []byte
)

func file_config_broker_rocketmq_v1_rocketmq_proto_rawDescGZIP() []byte {
	file_config_broker_rocketmq_v1_rocketmq_proto_rawDescOnce.Do(func() {
		file_config_broker_rocketmq_v1_rocketmq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_broker_rocketmq_v1_rocketmq_proto_rawDesc), len(file_config_broker_rocketmq_v1_rocketmq_proto_rawDesc)))
	})
	return file_config_broker_rocketmq_v1_rocketmq_proto_rawDescData
}

var file_config_broker_rocketmq_v1_rocketmq_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_config_broker_rocketmq_v1_rocketmq_proto_goTypes = []any{
	(*RocketMQConfig)(nil), // 0: config.broker.rocketmq.v1.RocketMQConfig
}
var file_config_broker_rocketmq_v1_rocketmq_proto_depIdxs = []int32{
...
func init() { file_config_broker_rocketmq_v1_rocketmq_proto_init() }
func file_config_broker_rocketmq_v1_rocketmq_proto_init() {
	if File_config_broker_rocketmq_v1_rocketmq_proto != nil {
		return
	}
	file_config_broker_rocketmq_v1_rocketmq_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_broker_rocketmq_v1_rocketmq_proto_rawDesc), len(file_config_broker_rocketmq_v1_rocketmq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_broker_rocketmq_v1_rocketmq_proto_goTypes,
		DependencyIndexes: file_config_broker_rocketmq_v1_rocketmq_proto_depIdxs,
		MessageInfos:      file_config_broker_rocketmq_v1_rocketmq_proto_msgTypes,
	}.Build()
	File_config_broker_rocketmq_v1_rocketmq_proto = out.File
	file_config_broker_rocketmq_v1_rocketmq_proto_goTypes = nil
	file_config_broker_rocketmq_v1_rocketmq_proto_depIdxs = nil
}
