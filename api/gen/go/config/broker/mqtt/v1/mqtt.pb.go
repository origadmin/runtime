...
func (x *MqttConfig) Reset() {
	*x = MqttConfig{}
	mi := &file_config_broker_mqtt_v1_mqtt_proto_msgTypes[0]
...
func (*MqttConfig) Descriptor() ([]byte, []int) {
	return file_config_broker_mqtt_v1_mqtt_proto_rawDescGZIP(), []int{0}
}
...
var File_config_broker_mqtt_v1_mqtt_proto protoreflect.FileDescriptor

const file_config_broker_mqtt_v1_mqtt_proto_rawDesc = "" +
	"\n" +
	" config/broker/mqtt/v1/mqtt.proto\x12\x15config.broker.mqtt.v1\x1a$gnostic/openapi/v3/annotations.proto\"\xea\n" +
	"\n" +
	"\n" +
	"MqttConfig\x12S\n" +
	...
	"\x0e_clean_sessionB\xe3\x01\n" +
	"\x19com.config.broker.mqtt.v1B\tMqttProtoP\x01ZDgithub.com/origadmin/runtime/api/gen/go/config/broker/mqtt/v1;mqttv1\xa2\x02\x03CBM\xaa\x02\x15Config.Broker.Mqtt.V1\xca\x02\x15Config\\Broker\\Mqtt\\V1\xe2\x02!Config\\Broker\\Mqtt\\V1\\GPBMetadata\xea\x02\x18Config::Broker::Mqtt::V1b\x06proto3"

var (
	file_config_broker_mqtt_v1_mqtt_proto_rawDescOnce sync.Once
	file_config_broker_mqtt_v1_mqtt_proto_rawDescData []byte
)

func file_config_broker_mqtt_v1_mqtt_proto_rawDescGZIP() []byte {
	file_config_broker_mqtt_v1_mqtt_proto_rawDescOnce.Do(func() {
		file_config_broker_mqtt_v1_mqtt_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_broker_mqtt_v1_mqtt_proto_rawDesc), len(file_config_broker_mqtt_v1_mqtt_proto_rawDesc)))
	})
	return file_config_broker_mqtt_v1_mqtt_proto_rawDescData
}

var file_config_broker_mqtt_v1_mqtt_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_config_broker_mqtt_v1_mqtt_proto_goTypes = []any{
	(*MqttConfig)(nil), // 0: config.broker.mqtt.v1.MqttConfig
}
var file_config_broker_mqtt_v1_mqtt_proto_depIdxs = []int32{
...
func init() { file_config_broker_mqtt_v1_mqtt_proto_init() }
func file_config_broker_mqtt_v1_mqtt_proto_init() {
	if File_config_broker_mqtt_v1_mqtt_proto != nil {
		return
	}
	file_config_broker_mqtt_v1_mqtt_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_broker_mqtt_v1_mqtt_proto_rawDesc), len(file_config_broker_mqtt_v1_mqtt_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_broker_mqtt_v1_mqtt_proto_goTypes,
		DependencyIndexes: file_config_broker_mqtt_v1_mqtt_proto_depIdxs,
		MessageInfos:      file_config_broker_mqtt_v1_mqtt_proto_msgTypes,
	}.Build()
	File_config_broker_mqtt_v1_mqtt_proto = out.File
	file_config_broker_mqtt_v1_mqtt_proto_goTypes = nil
	file_config_broker_mqtt_v1_mqtt_proto_depIdxs = nil
}
