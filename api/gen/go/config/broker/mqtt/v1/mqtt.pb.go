...
const file_config_broker_mqtt_v1_mqtt_proto_rawDesc = "" +
	...
	"\x0e_clean_sessionB\xa3\x02\n" +
	"%com.runtime.api.config.broker.mqtt.v1B\tMqttProtoP\x01ZDgithub.com/origadmin/runtime/api/gen/go/config/broker/mqtt/v1;mqttv1\xa2\x02\x05RACBM\xaa\x02!Runtime.Api.Config.Broker.Mqtt.V1\xca\x02!Runtime\\Api\\Config\\Broker\\Mqtt\\V1\xe2\x02-Runtime\\Api\\Config\\Broker\\Mqtt\\V1\\GPBMetadata\xea\x02&Runtime::Api::Config::Broker::Mqtt::V1b\x06proto3"
...
var file_config_broker_mqtt_v1_mqtt_proto_goTypes = []any{
	(*MqttConfig)(nil), // 0: runtime.api.config.broker.mqtt.v1.MqttConfig
}
