...
import (
	...
	_ "github.com/origadmin/runtime/api/gen/go/config/transport/tls/v1"
...
var file_config_source_v1_source_proto_goTypes = []any{
	(*Sources)(nil),          // 0: runtime.api.config.source.v1.Sources
	(*SourceConfig)(nil),     // 1: runtime.api.config.source.v1.SourceConfig
	(*EnvSource)(nil),        // 2: runtime.api.config.source.v1.EnvSource
	(*FileSource)(nil),       // 3: runtime.api.config.source.v1.FileSource
	(*ETCDSource)(nil),       // 4: runtime.api.config.source.v1.ETCDSource
	(*ConsulSource)(nil),     // 5: runtime.api.config.source.v1.ConsulSource
	(*NacosSource)(nil),      // 6: runtime.api.config.source.v1.NacosSource
	(*ApolloSource)(nil),     // 7: runtime.api.config.source.v1.ApolloSource
	(*KubernetesSource)(nil), // 8: runtime.api.config.source.v1.KubernetesSource
	(*PolarisSource)(nil),    // 9: runtime.api.config.source.v1.PolarisSource
	(*structpb.Struct)(nil),  // 10: google.protobuf.Struct
}
var file_config_source_v1_source_proto_depIdxs = []int32{
	1,  // 0: runtime.api.config.source.v1.Sources.configs:type_name -> runtime.api.config.source.v1.SourceConfig
	2,  // 1: runtime.api.config.source.v1.SourceConfig.env:type_name -> runtime.api.config.source.v1.EnvSource
	3,  // 2: runtime.api.config.source.v1.SourceConfig.file:type_name -> runtime.api.config.source.v1.FileSource
	4,  // 3: runtime.api.config.source.v1.SourceConfig.etcd:type_name -> runtime.api.config.source.v1.ETCDSource
	5,  // 4: runtime.api.config.source.v1.SourceConfig.consul:type_name -> runtime.api.config.source.v1.ConsulSource
	6,  // 5: runtime.api.config.source.v1.SourceConfig.nacos:type_name -> runtime.api.config.source.v1.NacosSource
