...
const file_config_security_v1_error_proto_rawDesc = "" +
	"\n" +
	"\x1econfig/security/v1/error.proto\x12\x12config.security.v1\x1a\x13errors/errors.proto*\xd9\x02\n" +
	...
	"\x15INVALID_AUTHORIZATION\x10\xd0\x0f\x1a\x04\xa8E\x93\x03\x1a\x04\xa0E\xf4\x03B\xd5\x01\n" +
	"\x16com.config.security.v1B\n" +
	"ErrorProtoP\x01ZEgithub.com/origadmin/runtime/api/gen/go/config/security/v1;securityv1\xa2\x02\x03CSX\xaa\x02\x12Config.Security.V1\xca\x02\x12Config\\Security\\V1\xe2\x02\x1eConfig\\Security\\V1\\GPBMetadata\xea\x02\x14Config::Security::V1b\x06proto3"
...
var file_config_security_v1_error_proto_goTypes = []any{
	(SecurityErrorReason)(0), // 0: config.security.v1.SecurityErrorReason
}
