...
func (x *TLSConfig) Reset() {
	*x = TLSConfig{}
	mi := &file_config_security_transport_v1_tls_proto_msgTypes[0]
...
func (*TLSConfig) Descriptor() ([]byte, []int) {
	return file_config_security_transport_v1_tls_proto_rawDescGZIP(), []int{0}
}
...
func (x *FileConfig) Reset() {
	*x = FileConfig{}
	mi := &file_config_security_transport_v1_tls_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FileConfig) Descriptor() ([]byte, []int) {
	return file_config_security_transport_v1_tls_proto_rawDescGZIP(), []int{1}
}
...
func (x *PEMConfig) Reset() {
	*x = PEMConfig{}
	mi := &file_config_security_transport_v1_tls_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PEMConfig) Descriptor() ([]byte, []int) {
	return file_config_security_transport_v1_tls_proto_rawDescGZIP(), []int{2}
}
...
var File_config_security_transport_v1_tls_proto protoreflect.FileDescriptor

const file_config_security_transport_v1_tls_proto_rawDesc = "" +
	"\n" +
	"&config/security/transport/v1/tls.proto\x12(runtime.api.config.security.transport.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x17validate/validate.proto\"\x86\v\n" +
	"\tTLSConfig\x12J\n" +
	"\x04name\x18\x01 \x01(\tB6\xbaG3\x92\x020Unique name for this TLS configuration instance.R\x04name\x12N\n" +
	"\aenabled\x18\x02 \x01(\bB4\xbaG1\x92\x02.Whether TLS is enabled for this configuration.R\aenabled\x12z\n" +
	"\x04file\x18\x03 \x01(\v24.runtime.api.config.security.transport.v1.FileConfigB+\xbaG(\x92\x02%File-based certificate configuration.H\x00R\x04file\x88\x01\x01\x12v\n" +
	"\x03pem\x18\x04 \x01(\v23.runtime.api.config.security.transport.v1.PEMConfigB*\xbaG'\x92\x02$Inline PEM-encoded certificate data.H\x01R\x03pem\x88\x01\x01\x12\x97\x01\n" +
	...
	"\x02ca\x18\x03 \x01(\fBP\xbaGM\x92\x02JPEM-encoded CA certificate data for verifying peer certificates. Optional.R\x02caB\xd1\x02\n" +
	",com.runtime.api.config.security.transport.v1B\bTlsProtoP\x01ZPgithub.com/origadmin/runtime/api/gen/go/config/security/transport/v1;transportv1\xa2\x02\x05RACST\xaa\x02(Runtime.Api.Config.Security.Transport.V1\xca\x02(Runtime\\Api\\Config\\Security\\Transport\\V1\xe2\x024Runtime\\Api\\Config\\Security\\Transport\\V1\\GPBMetadata\xea\x02-Runtime::Api::Config::Security::Transport::V1b\x06proto3"

var (
	file_config_security_transport_v1_tls_proto_rawDescOnce sync.Once
	file_config_security_transport_v1_tls_proto_rawDescData []byte
)

func file_config_security_transport_v1_tls_proto_rawDescGZIP() []byte {
	file_config_security_transport_v1_tls_proto_rawDescOnce.Do(func() {
		file_config_security_transport_v1_tls_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_security_transport_v1_tls_proto_rawDesc), len(file_config_security_transport_v1_tls_proto_rawDesc)))
	})
	return file_config_security_transport_v1_tls_proto_rawDescData
}

var file_config_security_transport_v1_tls_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_config_security_transport_v1_tls_proto_goTypes = []any{
	(*TLSConfig)(nil),       // 0: runtime.api.config.security.transport.v1.TLSConfig
	(*FileConfig)(nil),      // 1: runtime.api.config.security.transport.v1.FileConfig
	(*PEMConfig)(nil),       // 2: runtime.api.config.security.transport.v1.PEMConfig
	(*structpb.Struct)(nil), // 3: google.protobuf.Struct
}
var file_config_security_transport_v1_tls_proto_depIdxs = []int32{
	1, // 0: runtime.api.config.security.transport.v1.TLSConfig.file:type_name -> runtime.api.config.security.transport.v1.FileConfig
	2, // 1: runtime.api.config.security.transport.v1.TLSConfig.pem:type_name -> runtime.api.config.security.transport.v1.PEMConfig
	3, // 2: runtime.api.config.security.transport.v1.TLSConfig.customize:type_name -> google.protobuf.Struct
...
func init() { file_config_security_transport_v1_tls_proto_init() }
func file_config_security_transport_v1_tls_proto_init() {
	if File_config_security_transport_v1_tls_proto != nil {
		return
	}
	file_config_security_transport_v1_tls_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_security_transport_v1_tls_proto_rawDesc), len(file_config_security_transport_v1_tls_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_security_transport_v1_tls_proto_goTypes,
		DependencyIndexes: file_config_security_transport_v1_tls_proto_depIdxs,
		MessageInfos:      file_config_security_transport_v1_tls_proto_msgTypes,
	}.Build()
	File_config_security_transport_v1_tls_proto = out.File
	file_config_security_transport_v1_tls_proto_goTypes = nil
	file_config_security_transport_v1_tls_proto_depIdxs = nil
}
