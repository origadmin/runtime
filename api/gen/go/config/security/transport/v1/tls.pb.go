...
const file_config_security_transport_v1_tls_proto_rawDesc = "" +
	"\n" +
	"&config/security/transport/v1/tls.proto\x12\x1cconfig.security.transport.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x17validate/validate.proto\"\xee\n" +
	"\n" +
	"\tTLSConfig\x12J\n" +
	"\x04name\x18\x01 \x01(\tB6\xbaG3\x92\x020Unique name for this TLS configuration instance.R\x04name\x12N\n" +
	"\aenabled\x18\x02 \x01(\bB4\xbaG1\x92\x02.Whether TLS is enabled for this configuration.R\aenabled\x12n\n" +
	"\x04file\x18\x03 \x01(\v2(.config.security.transport.v1.FileConfigB+\xbaG(\x92\x02%File-based certificate configuration.H\x00R\x04file\x88\x01\x01\x12j\n" +
	"\x03pem\x18\x04 \x01(\v2'.config.security.transport.v1.PEMConfigB*\xbaG'\x92\x02$Inline PEM-encoded certificate data.H\x01R\x03pem\x88\x01\x01\x12\x97\x01\n" +
	...
	"\x02ca\x18\x03 \x01(\fBP\xbaGM\x92\x02JPEM-encoded CA certificate data for verifying peer certificates. Optional.R\x02caB\x91\x02\n" +
	" com.config.security.transport.v1B\bTlsProtoP\x01ZPgithub.com/origadmin/runtime/api/gen/go/config/security/transport/v1;transportv1\xa2\x02\x03CST\xaa\x02\x1cConfig.Security.Transport.V1\xca\x02\x1cConfig\\Security\\Transport\\V1\xe2\x02(Config\\Security\\Transport\\V1\\GPBMetadata\xea\x02\x1fConfig::Security::Transport::V1b\x06proto3"
...
var file_config_security_transport_v1_tls_proto_goTypes = []any{
	(*TLSConfig)(nil),       // 0: config.security.transport.v1.TLSConfig
	(*FileConfig)(nil),      // 1: config.security.transport.v1.FileConfig
	(*PEMConfig)(nil),       // 2: config.security.transport.v1.PEMConfig
	(*structpb.Struct)(nil), // 3: google.protobuf.Struct
}
var file_config_security_transport_v1_tls_proto_depIdxs = []int32{
	1, // 0: config.security.transport.v1.TLSConfig.file:type_name -> config.security.transport.v1.FileConfig
	2, // 1: config.security.transport.v1.TLSConfig.pem:type_name -> config.security.transport.v1.PEMConfig
	3, // 2: config.security.transport.v1.TLSConfig.customize:type_name -> google.protobuf.Struct
