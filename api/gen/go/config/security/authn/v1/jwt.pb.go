...
// 	protoc        (unknown)
// source: config/security/authn/v1/jwt.proto
...
func (x *Config) Reset() {
	*x = Config{}
	mi := &file_config_security_authn_v1_jwt_proto_msgTypes[0]
...
func (*Config) Descriptor() ([]byte, []int) {
	return file_config_security_authn_v1_jwt_proto_rawDescGZIP(), []int{0}
}
...
var File_config_security_authn_v1_jwt_proto protoreflect.FileDescriptor

const file_config_security_authn_v1_jwt_proto_rawDesc = "" +
	"\n" +
	"\"config/security/authn/v1/jwt.proto\x12\x18config.security.authn.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x17validate/validate.proto\"\xda\x05\n" +
	...
	"token_typeB\xf5\x01\n" +
	"\x1ccom.config.security.authn.v1B\bJwtProtoP\x01ZHgithub.com/origadmin/runtime/api/gen/go/config/security/authn/v1;authnv1\xa2\x02\x03CSA\xaa\x02\x18Config.Security.Authn.V1\xca\x02\x18Config\\Security\\Authn\\V1\xe2\x02$Config\\Security\\Authn\\V1\\GPBMetadata\xea\x02\x1bConfig::Security::Authn::V1b\x06proto3"

var (
	file_config_security_authn_v1_jwt_proto_rawDescOnce sync.Once
	file_config_security_authn_v1_jwt_proto_rawDescData []byte
)

func file_config_security_authn_v1_jwt_proto_rawDescGZIP() []byte {
	file_config_security_authn_v1_jwt_proto_rawDescOnce.Do(func() {
		file_config_security_authn_v1_jwt_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_security_authn_v1_jwt_proto_rawDesc), len(file_config_security_authn_v1_jwt_proto_rawDesc)))
	})
	return file_config_security_authn_v1_jwt_proto_rawDescData
}

var file_config_security_authn_v1_jwt_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_config_security_authn_v1_jwt_proto_goTypes = []any{
	(*Config)(nil), // 0: config.security.authn.v1.Config
}
var file_config_security_authn_v1_jwt_proto_depIdxs = []int32{
...
func init() { file_config_security_authn_v1_jwt_proto_init() }
func file_config_security_authn_v1_jwt_proto_init() {
	if File_config_security_authn_v1_jwt_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_security_authn_v1_jwt_proto_rawDesc), len(file_config_security_authn_v1_jwt_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_security_authn_v1_jwt_proto_goTypes,
		DependencyIndexes: file_config_security_authn_v1_jwt_proto_depIdxs,
		MessageInfos:      file_config_security_authn_v1_jwt_proto_msgTypes,
	}.Build()
	File_config_security_authn_v1_jwt_proto = out.File
	file_config_security_authn_v1_jwt_proto_goTypes = nil
	file_config_security_authn_v1_jwt_proto_depIdxs = nil
}
