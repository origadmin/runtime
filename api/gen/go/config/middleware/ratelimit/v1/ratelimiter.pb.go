...
const file_config_middleware_ratelimit_v1_ratelimiter_proto_rawDesc = "" +
	"\n" +
	"0config/middleware/ratelimit/v1/ratelimiter.proto\x12\x1econfig.middleware.ratelimit.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x17validate/validate.proto\"\xb9\x06\n" +
	"\vRateLimiter\x12x\n" +
	...
	"\vretry_after\x18\a \x01(\x05R\vretry_after\x12J\n" +
	"\x06memory\x18e \x01(\v22.config.middleware.ratelimit.v1.RateLimiter.MemoryR\x06memory\x12G\n" +
	"\x05redis\x18f \x01(\v21.config.middleware.ratelimit.v1.RateLimiter.RedisR\x05redis\x12\x85\x01\n" +
	...
	"\n" +
	"_customizeB\xa5\x02\n" +
	"\"com.config.middleware.ratelimit.v1B\x10RatelimiterProtoP\x01ZRgithub.com/origadmin/runtime/api/gen/go/config/middleware/ratelimit/v1;ratelimitv1\xa2\x02\x03CMR\xaa\x02\x1eConfig.Middleware.Ratelimit.V1\xca\x02\x1eConfig\\Middleware\\Ratelimit\\V1\xe2\x02*Config\\Middleware\\Ratelimit\\V1\\GPBMetadata\xea\x02!Config::Middleware::Ratelimit::V1b\x06proto3"
...
var file_config_middleware_ratelimit_v1_ratelimiter_proto_goTypes = []any{
	(*RateLimiter)(nil),        // 0: config.middleware.ratelimit.v1.RateLimiter
	(*RateLimiter_Redis)(nil),  // 1: config.middleware.ratelimit.v1.RateLimiter.Redis
	(*RateLimiter_Memory)(nil), // 2: config.middleware.ratelimit.v1.RateLimiter.Memory
	(*structpb.Struct)(nil),    // 3: google.protobuf.Struct
}
var file_config_middleware_ratelimit_v1_ratelimiter_proto_depIdxs = []int32{
	2, // 0: config.middleware.ratelimit.v1.RateLimiter.memory:type_name -> config.middleware.ratelimit.v1.RateLimiter.Memory
	1, // 1: config.middleware.ratelimit.v1.RateLimiter.redis:type_name -> config.middleware.ratelimit.v1.RateLimiter.Redis
	3, // 2: config.middleware.ratelimit.v1.RateLimiter.customize:type_name -> google.protobuf.Struct
