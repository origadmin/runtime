...
const file_config_middleware_cors_v1_cors_proto_rawDesc = "" +
	"\n" +
	"$config/middleware/cors/v1/cors.proto\x12%runtime.api.config.middleware.cors.v1\"\xac\t\n" +
	"\x04Cors\x12\x14\n" +
	...
	"\vallow_files\x18# \x01(\bR\vallow_filesB\xbb\x02\n" +
	")com.runtime.api.config.middleware.cors.v1B\tCorsProtoP\x01ZHgithub.com/origadmin/runtime/api/gen/go/config/middleware/cors/v1;corsv1\xa2\x02\x05RACMC\xaa\x02%Runtime.Api.Config.Middleware.Cors.V1\xca\x02%Runtime\\Api\\Config\\Middleware\\Cors\\V1\xe2\x021Runtime\\Api\\Config\\Middleware\\Cors\\V1\\GPBMetadata\xea\x02*Runtime::Api::Config::Middleware::Cors::V1b\x06proto3"
...
var file_config_middleware_cors_v1_cors_proto_goTypes = []any{
	(*Cors)(nil), // 0: runtime.api.config.middleware.cors.v1.Cors
}
