...
const file_config_middleware_v1_middleware_proto_rawDesc = "" +
	...
	"\aenabled\x18\x03 \x01(\bB(\xbaG%\x92\x02\"Whether the middleware is enabled.R\aenabled\x12w\n" +
	"\frate_limiter\x18\x04 \x01(\v2+.config.middleware.ratelimit.v1.RateLimiterB!\xbaG\x1e\x92\x02\x1bRate limiter configuration.H\x00R\frate_limiter\x88\x01\x01\x12b\n" +
	"\ametrics\x18\x05 \x01(\v2%.config.middleware.metrics.v1.MetricsB\x1c\xbaG\x19\x92\x02\x16Metrics configuration.H\x01R\ametrics\x88\x01\x01\x12l\n" +
	"\tvalidator\x18\x06 \x01(\v2).config.middleware.validator.v1.ValidatorB\x1e\xbaG\x1b\x92\x02\x18Validator configuration.H\x02R\tvalidator\x88\x01\x01\x12Y\n" +
	"\x03jwt\x18\a \x01(\v2\x1d.config.middleware.jwt.v1.JWTB#\xbaG \x92\x02\x1dJWT middleware configuration.H\x03R\x03jwt\x88\x01\x01\x12r\n" +
	"\bselector\x18\b \x01(\v2'.config.middleware.selector.v1.SelectorB(\xbaG%\x92\x02\"Selector middleware configuration.H\x04R\bselector\x88\x01\x01\x12^\n" +
	"\x04cors\x18\t \x01(\v2\x1f.config.middleware.cors.v1.CorsB$\xbaG!\x92\x02\x1eCORS middleware configuration.H\x05R\x04cors\x88\x01\x01\x12\x88\x01\n" +
	...
	"_customize\"\x8c\x01\n" +
	"\vMiddlewares\x12}\n" +
	"\aconfigs\x18\x01 \x03(\v2 .config.middleware.v1.MiddlewareBA\xbaG>\x92\x02;A list of middleware configurations to be applied in order.R\aconfigsB\xe8\x01\n" +
	"\x18com.config.middleware.v1B\x0fMiddlewareProtoP\x01ZIgithub.com/origadmin/runtime/api/gen/go/config/middleware/v1;middlewarev1\xa2\x02\x03CMX\xaa\x02\x14Config.Middleware.V1\xca\x02\x14Config\\Middleware\\V1\xe2\x02 Config\\Middleware\\V1\\GPBMetadata\xea\x02\x16Config::Middleware::V1b\x06proto3"
...
var file_config_middleware_v1_middleware_proto_goTypes = []any{
	(*Metadata)(nil),           // 0: config.middleware.v1.Metadata
	(*Logging)(nil),            // 1: config.middleware.v1.Logging
	(*Recovery)(nil),           // 2: config.middleware.v1.Recovery
	(*Middleware)(nil),         // 3: config.middleware.v1.Middleware
	(*Middlewares)(nil),        // 4: config.middleware.v1.Middlewares
	nil,                        // 5: config.middleware.v1.Metadata.DataEntry
	(*v1.RateLimiter)(nil),     // 6: config.middleware.ratelimit.v1.RateLimiter
	(*v11.Metrics)(nil),        // 7: config.middleware.metrics.v1.Metrics
	(*v12.Validator)(nil),      // 8: config.middleware.validator.v1.Validator
	(*v13.JWT)(nil),            // 9: config.middleware.jwt.v1.JWT
...
var file_config_middleware_v1_middleware_proto_depIdxs = []int32{
	...
	6,  // 1: config.middleware.v1.Middleware.rate_limiter:type_name -> config.middleware.ratelimit.v1.RateLimiter
	7,  // 2: config.middleware.v1.Middleware.metrics:type_name -> config.middleware.metrics.v1.Metrics
	8,  // 3: config.middleware.v1.Middleware.validator:type_name -> config.middleware.validator.v1.Validator
	9,  // 4: config.middleware.v1.Middleware.jwt:type_name -> config.middleware.jwt.v1.JWT
	10, // 5: config.middleware.v1.Middleware.selector:type_name -> config.middleware.selector.v1.Selector
	11, // 6: config.middleware.v1.Middleware.cors:type_name -> config.middleware.cors.v1.Cors
	12, // 7: config.middleware.v1.Middleware.circuit_breaker:type_name -> config.middleware.circuitbreaker.v1.CircuitBreaker
