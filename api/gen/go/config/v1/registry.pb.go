...
// Registry defines the configuration for service registration and discovery.
type Registry struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The name of the service to be registered with the discovery service.
...
const file_config_v1_registry_proto_rawDesc = "" +
	"\n" +
	"\x18config/v1/registry.proto\x12\tconfig.v1\"\x1e\n" +
	"\bRegistry\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04nameB\x9f\x01\n" +
	"\rcom.config.v1B\rRegistryProtoP\x01Z:github.com/origadmin/runtime/api/gen/go/config/v1;configv1\xa2\x02\x03CXX\xaa\x02\tConfig.V1\xca\x02\tConfig\\V1\xe2\x02\x15Config\\V1\\GPBMetadata\xea\x02\n" +
...
var file_config_v1_registry_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
