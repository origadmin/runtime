...
const file_config_v1_task_proto_rawDesc = "" +
	"\n" +
	"\x14config/v1/task.proto\x12\tconfig.v1\"\x06\n" +
	"\x04TaskB\x9b\x01\n" +
	"\rcom.config.v1B\tTaskProtoP\x01Z:github.com/origadmin/runtime/api/gen/go/config/v1;configv1\xa2\x02\x03CXX\xaa\x02\tConfig.V1\xca\x02\tConfig\\V1\xe2\x02\x15Config\\V1\\GPBMetadata\xea\x02\n" +
...
var file_config_v1_task_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
