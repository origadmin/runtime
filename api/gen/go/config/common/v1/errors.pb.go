...
type ErrorMetadata struct {
	...
	Category ErrorCategory `protobuf:"varint,1,opt,name=category,proto3,enum=config.common.v1.ErrorCategory" json:"category,omitempty"`
...
const file_config_common_v1_errors_proto_rawDesc = "" +
	"\n" +
	"\x1dconfig/common/v1/errors.proto\x12\x10config.common.v1\x1a\x13errors/errors.proto\x1a$gnostic/openapi/v3/annotations.proto\"\xbc\x02\n" +
	"\rErrorMetadata\x12]\n" +
	"\bcategory\x18\x01 \x01(\x0e2\x1f.config.common.v1.ErrorCategoryB \xbaG\x1d\x92\x02\x1aThe category of the error.R\bcategory\x12\x8e\x01\n" +
	"\bmetadata\x18\x02 \x03(\v2-.config.common.v1.ErrorMetadata.MetadataEntryBC\xbaG@\x92\x02=Additional key-value pairs providing context about the error.R\bmetadata\x1a;\n" +
	...
	"\x12REGISTRY_NOT_FOUND\x10\xf0.\x1a\x04\xa8E\x94\x03\x1a\x04\xa0E\xf4\x03B\xc8\x01\n" +
	"\x14com.config.common.v1B\vErrorsProtoP\x01ZAgithub.com/origadmin/runtime/api/gen/go/config/common/v1;commonv1\xa2\x02\x03CCX\xaa\x02\x10Config.Common.V1\xca\x02\x10Config\\Common\\V1\xe2\x02\x1cConfig\\Common\\V1\\GPBMetadata\xea\x02\x12Config::Common::V1b\x06proto3"
...
var file_config_common_v1_errors_proto_goTypes = []any{
	(ErrorCategory)(0),    // 0: config.common.v1.ErrorCategory
	(ErrorReason)(0),      // 1: config.common.v1.ErrorReason
	(*ErrorMetadata)(nil), // 2: config.common.v1.ErrorMetadata
	nil,                   // 3: config.common.v1.ErrorMetadata.MetadataEntry
}
var file_config_common_v1_errors_proto_depIdxs = []int32{
	0, // 0: config.common.v1.ErrorMetadata.category:type_name -> config.common.v1.ErrorCategory
	3, // 1: config.common.v1.ErrorMetadata.metadata:type_name -> config.common.v1.ErrorMetadata.MetadataEntry
