...
const file_config_common_v1_pagination_proto_rawDesc = "" +
	"\n" +
	"!config/common/v1/pagination.proto\x12\x10config.common.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x19google/protobuf/any.proto\x1a google/protobuf/field_mask.proto\"\xfb\a\n" +
	...
	"\x0fnext_page_token\x18\x04 \x01(\tBX\xbaGU\x92\x02RA token to retrieve the next page of results. If empty, there are no more results.R\x0fnext_page_token\x12\x8b\x01\n" +
	"\x05extra\x18\x05 \x03(\v2'.config.common.v1.Pagination.ExtraEntryBL\xbaGI\x92\x02FAdditional information about this response, stored as key-value pairs.R\x05extra\x1aN\n" +
	"\n" +
	"ExtraEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x05value:\x028\x01B\xcc\x01\n" +
	"\x14com.config.common.v1B\x0fPaginationProtoP\x01ZAgithub.com/origadmin/runtime/api/gen/go/config/common/v1;commonv1\xa2\x02\x03CCX\xaa\x02\x10Config.Common.V1\xca\x02\x10Config\\Common\\V1\xe2\x02\x1cConfig\\Common\\V1\\GPBMetadata\xea\x02\x12Config::Common::V1b\x06proto3"
...
var file_config_common_v1_pagination_proto_goTypes = []any{
	(*PaginationRequest)(nil),     // 0: config.common.v1.PaginationRequest
	(*Pagination)(nil),            // 1: config.common.v1.Pagination
	nil,                           // 2: config.common.v1.Pagination.ExtraEntry
	(*fieldmaskpb.FieldMask)(nil), // 3: google.protobuf.FieldMask
	(*anypb.Any)(nil),             // 4: google.protobuf.Any
}
var file_config_common_v1_pagination_proto_depIdxs = []int32{
	3, // 0: config.common.v1.PaginationRequest.field_mask:type_name -> google.protobuf.FieldMask
	2, // 1: config.common.v1.Pagination.extra:type_name -> config.common.v1.Pagination.ExtraEntry
	4, // 2: config.common.v1.Pagination.ExtraEntry.value:type_name -> google.protobuf.Any
