...
// Validate checks the field values on ObjectInfo with the rules defined in the
...
// ValidateAll checks the field values on ObjectInfo with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in ObjectInfoMultiError, or
// nil if none found.
func (m *ObjectInfo) ValidateAll() error {
	return m.validate(true)
}

func (m *ObjectInfo) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, ObjectInfoValidationError{
					field:  "ModTime",
		...
		if err := v.Validate(); err != nil {
			return ObjectInfoValidationError{
				field:  "ModTime",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return ObjectInfoMultiError(errors)
	}

	return nil
}

// ObjectInfoMultiError is an error wrapping multiple validation errors
// returned by ObjectInfo.ValidateAll() if the designated constraints aren't met.
...
func (m ObjectInfoMultiError) AllErrors() []error { return m }

// ObjectInfoValidationError is the validation error returned by
// ObjectInfo.Validate if the designated constraints aren't met.
...
func (e ObjectInfoValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ObjectInfoValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ObjectInfoValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ObjectInfoValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ObjectInfoValidationError) ErrorName() string { return "ObjectInfoValidationError" }

// Error satisfies the builtin error interface
func (e ObjectInfoValidationError) Error() string {
	cause := ""
	if e.cause != nil {
...
var _ error = ObjectInfoValidationError{}
