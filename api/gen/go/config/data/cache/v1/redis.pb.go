...
const file_config_data_cache_v1_redis_proto_rawDesc = "" +
	"\n" +
	" config/data/cache/v1/redis.proto\x12\x14config.data.cache.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x17validate/validate.proto\"\xea\f\n" +
	"\vRedisConfig\x128\n" +
	...
	"\x19_tls_insecure_skip_verifyB\xdf\x01\n" +
	"\x18com.config.data.cache.v1B\n" +
	"RedisProtoP\x01ZDgithub.com/origadmin/runtime/api/gen/go/config/data/cache/v1;cachev1\xa2\x02\x03CDC\xaa\x02\x14Config.Data.Cache.V1\xca\x02\x14Config\\Data\\Cache\\V1\xe2\x02 Config\\Data\\Cache\\V1\\GPBMetadata\xea\x02\x17Config::Data::Cache::V1b\x06proto3"
...
var file_config_data_cache_v1_redis_proto_goTypes = []any{
	(*RedisConfig)(nil), // 0: config.data.cache.v1.RedisConfig
}
