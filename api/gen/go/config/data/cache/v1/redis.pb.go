...
// 	protoc        (unknown)
// source: config/data/cache/v1/redis.proto
...
func (x *RedisConfig) Reset() {
	*x = RedisConfig{}
	mi := &file_config_data_cache_v1_redis_proto_msgTypes[0]
...
func (*RedisConfig) Descriptor() ([]byte, []int) {
	return file_config_data_cache_v1_redis_proto_rawDescGZIP(), []int{0}
}
...
const file_config_data_cache_v1_redis_proto_rawDesc = "" +
	"\n" +
	" config/data/cache/v1/redis.proto\x12 runtime.api.config.data.cache.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x17validate/validate.proto\"\xea\f\n" +
	"\vRedisConfig\x128\n" +
	...
	"\x19_tls_insecure_skip_verifyB\x9f\x02\n" +
	"$com.runtime.api.config.data.cache.v1B\n" +
	"RedisProtoP\x01ZDgithub.com/origadmin/runtime/api/gen/go/config/data/cache/v1;cachev1\xa2\x02\x05RACDC\xaa\x02 Runtime.Api.Config.Data.Cache.V1\xca\x02 Runtime\\Api\\Config\\Data\\Cache\\V1\xe2\x02,Runtime\\Api\\Config\\Data\\Cache\\V1\\GPBMetadata\xea\x02%Runtime::Api::Config::Data::Cache::V1b\x06proto3"

var (
	file_config_data_cache_v1_redis_proto_rawDescOnce sync.Once
	file_config_data_cache_v1_redis_proto_rawDescData []byte
)

func file_config_data_cache_v1_redis_proto_rawDescGZIP() []byte {
	file_config_data_cache_v1_redis_proto_rawDescOnce.Do(func() {
		file_config_data_cache_v1_redis_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_data_cache_v1_redis_proto_rawDesc), len(file_config_data_cache_v1_redis_proto_rawDesc)))
	})
	return file_config_data_cache_v1_redis_proto_rawDescData
}

var file_config_data_cache_v1_redis_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_config_data_cache_v1_redis_proto_goTypes = []any{
	(*RedisConfig)(nil), // 0: runtime.api.config.data.cache.v1.RedisConfig
}
var file_config_data_cache_v1_redis_proto_depIdxs = []int32{
...
func init() { file_config_data_cache_v1_redis_proto_init() }
func file_config_data_cache_v1_redis_proto_init() {
	if File_config_data_cache_v1_redis_proto != nil {
		return
	}
	file_config_data_cache_v1_redis_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_data_cache_v1_redis_proto_rawDesc), len(file_config_data_cache_v1_redis_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_data_cache_v1_redis_proto_goTypes,
		DependencyIndexes: file_config_data_cache_v1_redis_proto_depIdxs,
		MessageInfos:      file_config_data_cache_v1_redis_proto_msgTypes,
	}.Build()
	File_config_data_cache_v1_redis_proto = out.File
	file_config_data_cache_v1_redis_proto_goTypes = nil
	file_config_data_cache_v1_redis_proto_depIdxs = nil
}
