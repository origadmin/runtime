...
const (
	FileService_List_FullMethodName           = "/config.data.file.v1.FileService/List"
	FileService_Stat_FullMethodName           = "/config.data.file.v1.FileService/Stat"
	FileService_Mkdir_FullMethodName          = "/config.data.file.v1.FileService/Mkdir"
	FileService_Delete_FullMethodName         = "/config.data.file.v1.FileService/Delete"
	FileService_Rename_FullMethodName         = "/config.data.file.v1.FileService/Rename"
	FileService_Read_FullMethodName           = "/config.data.file.v1.FileService/Read"
	FileService_Write_FullMethodName          = "/config.data.file.v1.FileService/Write"
	FileService_InitiateUpload_FullMethodName = "/config.data.file.v1.FileService/InitiateUpload"
	FileService_UploadChunk_FullMethodName    = "/config.data.file.v1.FileService/UploadChunk"
	FileService_FinalizeUpload_FullMethodName = "/config.data.file.v1.FileService/FinalizeUpload"
)
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "config.data.file.v1.FileService",
