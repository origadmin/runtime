...
const file_config_data_file_v1_oss_proto_rawDesc = "" +
	"\n" +
	"\x1dconfig/data/file/v1/oss.proto\x12\x1fruntime.api.config.data.file.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x17validate/validate.proto\"\x87\b\n" +
	"\tOssConfig\x12:\n" +
	...
	"\fread_timeout\x18\b \x01(\x03B)\xfaB\x04\"\x02(\x00\xbaG\x1f\x92\x02\x1cRead timeout in millisecondsR\fread_timeout\x12\x82\x01\n" +
	"\rbucket_policy\x18\t \x01(\v2-.runtime.api.config.data.file.v1.BucketPolicyB(\xbaG%\x92\x02\"Bucket access policy configurationH\x00R\rbucket_policy\x88\x01\x01\x12\x82\x01\n" +
	"\x0flifecycle_rules\x18\n" +
	" \x03(\v2..runtime.api.config.data.file.v1.LifecycleRuleB(\xbaG%\x92\x02\"List of lifecycle management rulesR\x0flifecycle_rules\x12m\n" +
	...
	"\fBucketPolicy\x12U\n" +
	"\x0fpolicy_document\x18\x01 \x01(\tB+\xbaG(\x92\x02%Access policy document in JSON formatR\x0fpolicy_document\"\x88\x06\n" +
	"\rLifecycleRule\x126\n" +
	...
	"\x06status\x18\x03 \x01(\tB<\xbaG9\x92\x026Status of the lifecycle rule (e.g., Enabled, Disabled)R\x06status\x12w\n" +
	"\n" +
	"expiration\x18\x04 \x01(\v2+.runtime.api.config.data.file.v1.ExpirationB%\xbaG\"\x92\x02\x1fObject expiration configurationH\x01R\n" +
	"expiration\x88\x01\x01\x12\x90\x01\n" +
	"\n" +
	"transition\x18\x05 \x01(\v2+.runtime.api.config.data.file.v1.TransitionB>\xbaG;\x92\x028Object transition to another storage class configurationH\x02R\n" +
	"transition\x88\x01\x01\x12\xc1\x01\n" +
	"\x1dnoncurrent_version_expiration\x18\x06 \x01(\v2<.runtime.api.config.data.file.v1.NoncurrentVersionExpirationB8\xbaG5\x92\x022Noncurrent object version expiration configurationH\x03R\x1dnoncurrent_version_expiration\x88\x01\x01B\t\n" +
	"\a_prefixB\r\n" +
	"\v_expirationB\r\n" +
	"\v_transitionB \n" +
	...
	"\x0fnoncurrent_days\x18\x01 \x01(\x05BH\xbaGE\x92\x02BNumber of days after the object becomes noncurrent when it expiresR\x0fnoncurrent_daysB\x96\x02\n" +
	"#com.runtime.api.config.data.file.v1B\bOssProtoP\x01ZBgithub.com/origadmin/runtime/api/gen/go/config/data/file/v1;filev1\xa2\x02\x05RACDF\xaa\x02\x1fRuntime.Api.Config.Data.File.V1\xca\x02\x1fRuntime\\Api\\Config\\Data\\File\\V1\xe2\x02+Runtime\\Api\\Config\\Data\\File\\V1\\GPBMetadata\xea\x02$Runtime::Api::Config::Data::File::V1b\x06proto3"
...
var file_config_data_file_v1_oss_proto_goTypes = []any{
	(*OssConfig)(nil),                   // 0: runtime.api.config.data.file.v1.OssConfig
	(*BucketPolicy)(nil),                // 1: runtime.api.config.data.file.v1.BucketPolicy
	(*LifecycleRule)(nil),               // 2: runtime.api.config.data.file.v1.LifecycleRule
	(*Expiration)(nil),                  // 3: runtime.api.config.data.file.v1.Expiration
	(*Transition)(nil),                  // 4: runtime.api.config.data.file.v1.Transition
	(*NoncurrentVersionExpiration)(nil), // 5: runtime.api.config.data.file.v1.NoncurrentVersionExpiration
}
var file_config_data_file_v1_oss_proto_depIdxs = []int32{
	1, // 0: runtime.api.config.data.file.v1.OssConfig.bucket_policy:type_name -> runtime.api.config.data.file.v1.BucketPolicy
	2, // 1: runtime.api.config.data.file.v1.OssConfig.lifecycle_rules:type_name -> runtime.api.config.data.file.v1.LifecycleRule
	3, // 2: runtime.api.config.data.file.v1.LifecycleRule.expiration:type_name -> runtime.api.config.data.file.v1.Expiration
	4, // 3: runtime.api.config.data.file.v1.LifecycleRule.transition:type_name -> runtime.api.config.data.file.v1.Transition
	5, // 4: runtime.api.config.data.file.v1.LifecycleRule.noncurrent_version_expiration:type_name -> runtime.api.config.data.file.v1.NoncurrentVersionExpiration
