...
// 	protoc        (unknown)
// source: config/data/database/v1/database.proto
...
func (x *DatabaseConfig) Reset() {
	*x = DatabaseConfig{}
	mi := &file_config_data_database_v1_database_proto_msgTypes[0]
...
func (*DatabaseConfig) Descriptor() ([]byte, []int) {
	return file_config_data_database_v1_database_proto_rawDescGZIP(), []int{0}
}
...
var File_config_data_database_v1_database_proto protoreflect.FileDescriptor

const file_config_data_database_v1_database_proto_rawDesc = "" +
	"\n" +
	"&config/data/database/v1/database.proto\x12\x17config.data.database.v1\x1a'config/data/database/v1/migration.proto\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x17validate/validate.proto\"\xcd\t\n" +
	...
	"\tmigration\x18\n" +
	" \x01(\v2\".config.data.database.v1.MigrationB\x14\xbaG\x11\x92\x02\x0edata migrationR\tmigration\x12>\n" +
	...
	"\n" +
	"_customizeB\xf7\x01\n" +
	"\x1bcom.config.data.database.v1B\rDatabaseProtoP\x01ZJgithub.com/origadmin/runtime/api/gen/go/config/data/database/v1;databasev1\xa2\x02\x03CDD\xaa\x02\x17Config.Data.Database.V1\xca\x02\x17Config\\Data\\Database\\V1\xe2\x02#Config\\Data\\Database\\V1\\GPBMetadata\xea\x02\x1aConfig::Data::Database::V1b\x06proto3"

var (
	file_config_data_database_v1_database_proto_rawDescOnce sync.Once
	file_config_data_database_v1_database_proto_rawDescData []byte
)

func file_config_data_database_v1_database_proto_rawDescGZIP() []byte {
	file_config_data_database_v1_database_proto_rawDescOnce.Do(func() {
		file_config_data_database_v1_database_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_data_database_v1_database_proto_rawDesc), len(file_config_data_database_v1_database_proto_rawDesc)))
	})
	return file_config_data_database_v1_database_proto_rawDescData
}

var file_config_data_database_v1_database_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_config_data_database_v1_database_proto_goTypes = []any{
	(*DatabaseConfig)(nil),  // 0: config.data.database.v1.DatabaseConfig
	(*Migration)(nil),       // 1: config.data.database.v1.Migration
	(*structpb.Struct)(nil), // 2: google.protobuf.Struct
}
var file_config_data_database_v1_database_proto_depIdxs = []int32{
	1, // 0: config.data.database.v1.DatabaseConfig.migration:type_name -> config.data.database.v1.Migration
	2, // 1: config.data.database.v1.DatabaseConfig.customize:type_name -> google.protobuf.Struct
...
func init() { file_config_data_database_v1_database_proto_init() }
func file_config_data_database_v1_database_proto_init() {
	if File_config_data_database_v1_database_proto != nil {
		return
	}
	file_config_data_database_v1_migration_proto_init()
	file_config_data_database_v1_database_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_data_database_v1_database_proto_rawDesc), len(file_config_data_database_v1_database_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_config_data_database_v1_database_proto_goTypes,
		DependencyIndexes: file_config_data_database_v1_database_proto_depIdxs,
		MessageInfos:      file_config_data_database_v1_database_proto_msgTypes,
	}.Build()
	File_config_data_database_v1_database_proto = out.File
	file_config_data_database_v1_database_proto_goTypes = nil
	file_config_data_database_v1_database_proto_depIdxs = nil
}
