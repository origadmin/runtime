...
type Endpoint struct {
	...
	Protocol      Protocol               `protobuf:"varint,4,opt,name=protocol,proto3,enum=runtime.api.config.config.v1.Protocol" json:"protocol,omitempty"`
...
type HealthCheck struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Type          HealthCheck_CheckType  `protobuf:"varint,1,opt,name=type,proto3,enum=runtime.api.config.config.v1.HealthCheck_CheckType" json:"type,omitempty"`
...
const file_config_config_v1_gateway_proto_rawDesc = "" +
	...
	"\tendpoints\x18\x03 \x03(\v2&.runtime.api.config.config.v1.EndpointB8\xbaG5\x92\x022List of endpoints for this priority configuration.R\tendpoints\"\xfe\a\n" +
	"\bEndpoint\x128\n" +
	...
	"\vdescription\x18\x03 \x01(\tB$\xbaG!\x92\x02\x1eA description of the endpoint.R\vdescription\x12z\n" +
	"\bprotocol\x18\x04 \x01(\x0e2&.runtime.api.config.config.v1.ProtocolB6\xbaG3\x92\x020The communication protocol used by the endpoint.R\bprotocol\x12M\n" +
	"\atimeout\x18\x05 \x01(\x03B3\xbaG0\x92\x02-The timeout for the endpoint in milliseconds.R\atimeout\x12\x88\x01\n" +
	"\vmiddlewares\x18\x06 \x03(\v2(.runtime.api.config.config.v1.MiddlewareB<\xbaG9\x92\x026List of middlewares applied to this specific endpoint.R\vmiddlewares\x12t\n" +
	"\bbackends\x18\a \x03(\v2%.runtime.api.config.config.v1.BackendB1\xbaG.\x92\x02+List of backend services for this endpoint.R\bbackends\x12_\n" +
	"\x05retry\x18\b \x01(\v2#.runtime.api.config.config.v1.RetryB$\xbaG!\x92\x02\x1eRetry policy for the endpoint.R\x05retry\x12}\n" +
	"\bmetadata\x18\t \x03(\v24.runtime.api.config.config.v1.Endpoint.MetadataEntryB+\xbaG(\x92\x02%Additional metadata for the endpoint.R\bmetadata\x124\n" +
	"\x04host\x18\n" +
	...
	"\brequired\x18\x03 \x01(\bB)\xbaG&\x92\x02#Whether the middleware is required.R\brequired\"\xcb\x05\n" +
	"\aBackend\x12g\n" +
	...
	"\x06weight\x18\x02 \x01(\x03B<\xbaG9\x92\x026The weight for load balancing among multiple backends.H\x00R\x06weight\x88\x01\x01\x12\x7f\n" +
	"\fhealth_check\x18\x03 \x01(\v2).runtime.api.config.config.v1.HealthCheckB1\xbaG.\x92\x02+Health check configuration for the backend.R\vhealthCheck\x12J\n" +
	"\x03tls\x18\x04 \x01(\bB8\xbaG5\x92\x022Whether TLS is enabled for the backend connection.R\x03tls\x12j\n" +
	"\x0ftls_config_name\x18\x05 \x01(\tBB\xbaG?\x92\x02<The name of the TLS configuration to use from the tls_store.R\rtlsConfigName\x12{\n" +
	"\bmetadata\x18\x06 \x03(\v23.runtime.api.config.config.v1.Backend.MetadataEntryB*\xbaG'\x92\x02$Additional metadata for the backend.R\bmetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\t\n" +
	"\a_weight\"\x99\x02\n" +
	"\vHealthCheck\x12s\n" +
	"\x04type\x18\x01 \x01(\x0e23.runtime.api.config.config.v1.HealthCheck.CheckTypeB*\xbaG'\x92\x02$The type of health check to perform.R\x04type\x12C\n" +
	...
	"\x0eCHECK_TYPE_TCP\x10\x02\"\xad\x03\n" +
	"\x05Retry\x12N\n" +
	"\battempts\x18\x01 \x01(\rB2\xbaG/\x92\x02,The number of retry attempts (default is 1).R\battempts\x12l\n" +
	"\x0fper_try_timeout\x18\x02 \x01(\x03BD\xbaGA\x92\x02>The timeout for each individual retry attempt in milliseconds.R\rperTryTimeout\x12\x82\x01\n" +
	"\n" +
	"conditions\x18\x03 \x03(\v2'.runtime.api.config.config.v1.ConditionB9\xbaG6\x92\x023Conditions under which a retry should be performed.R\n" +
	"conditions\x12a\n" +
	"\n" +
	"priorities\x18\x04 \x03(\tBA\xbaG>\x92\x02;List of priorities for retrying (e.g., primary, secondary).R\n" +
	"priorities\"\xca\x03\n" +
	"\tCondition\x12\x81\x01\n" +
	"\x0eby_status_code\x18\x01 \x01(\tBV\xbaGS\x92\x02PRetry if the response status code matches this pattern (e.g., \"500-599\", \"429\").H\x00R\fbyStatusCode\x88\x01\x01\x12\x90\x01\n" +
	"\tby_header\x18\x02 \x01(\v2..runtime.api.config.config.v1.Condition.HeaderB>\xbaG;\x92\x028Retry if a specific HTTP header matches the given value.H\x01R\bbyHeader\x88\x01\x01\x1a\x84\x01\n" +
	"\x06Header\x126\n" +
	...
	"\x0fPROTOCOL_CUSTOM\x10\x03B\x88\x02\n" +
	" com.runtime.api.config.config.v1B\fGatewayProtoP\x01ZAgithub.com/origadmin/runtime/api/gen/go/config/config/v1;configv1\xa2\x02\x04RACC\xaa\x02\x1cRuntime.Api.Config.Config.V1\xca\x02\x1cRuntime\\Api\\Config\\Config\\V1\xe2\x02(Runtime\\Api\\Config\\Config\\V1\\GPBMetadata\xea\x02 Runtime::Api::Config::Config::V1b\x06proto3"
...
var file_config_config_v1_gateway_proto_goTypes = []any{
	(Protocol)(0),              // 0: runtime.api.config.config.v1.Protocol
	(HealthCheck_CheckType)(0), // 1: runtime.api.config.config.v1.HealthCheck.CheckType
	(*Gateway)(nil),            // 2: runtime.api.config.config.v1.Gateway
	(*PriorityConfig)(nil),     // 3: runtime.api.config.config.v1.PriorityConfig
	(*Endpoint)(nil),           // 4: runtime.api.config.config.v1.Endpoint
	(*Middleware)(nil),         // 5: runtime.api.config.config.v1.Middleware
	(*Backend)(nil),            // 6: runtime.api.config.config.v1.Backend
	(*HealthCheck)(nil),        // 7: runtime.api.config.config.v1.HealthCheck
	(*Retry)(nil),              // 8: runtime.api.config.config.v1.Retry
	(*Condition)(nil),          // 9: runtime.api.config.config.v1.Condition
	nil,                        // 10: runtime.api.config.config.v1.Gateway.TlsStoreEntry
...
var file_config_config_v1_gateway_proto_depIdxs = []int32{
	...
	5,  // 1: runtime.api.config.config.v1.Gateway.middlewares:type_name -> runtime.api.config.config.v1.Middleware
	10, // 2: runtime.api.config.config.v1.Gateway.tls_store:type_name -> runtime.api.config.config.v1.Gateway.TlsStoreEntry
	4,  // 3: runtime.api.config.config.v1.PriorityConfig.endpoints:type_name -> runtime.api.config.config.v1.Endpoint
	0,  // 4: runtime.api.config.config.v1.Endpoint.protocol:type_name -> runtime.api.config.config.v1.Protocol
	5,  // 5: runtime.api.config.config.v1.Endpoint.middlewares:type_name -> runtime.api.config.config.v1.Middleware
	6,  // 6: runtime.api.config.config.v1.Endpoint.backends:type_name -> runtime.api.config.config.v1.Backend
	8,  // 7: runtime.api.config.config.v1.Endpoint.retry:type_name -> runtime.api.config.config.v1.Retry
	11, // 8: runtime.api.config.config.v1.Endpoint.metadata:type_name -> runtime.api.config.config.v1.Endpoint.MetadataEntry
	7,  // 9: runtime.api.config.config.v1.Backend.health_check:type_name -> runtime.api.config.config.v1.HealthCheck
	12, // 10: runtime.api.config.config.v1.Backend.metadata:type_name -> runtime.api.config.config.v1.Backend.MetadataEntry
