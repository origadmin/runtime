...
func (f *corsFactory) NewMiddlewareClient(cfg *middlewarev1.MiddlewareConfig, opts ...Option) (middleware.KMiddleware, bool) {
...
func (f *corsFactory) NewMiddlewareServer(cfg *middlewarev1.MiddlewareConfig, opts ...Option) (middleware.KMiddleware, bool) {
