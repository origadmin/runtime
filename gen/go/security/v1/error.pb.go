...
const file_security_v1_error_proto_rawDesc = "" +
	"\n" +
	"\x17security/v1/error.proto\x12\vsecurity.v1\x1a\x13errors/errors.proto*\xfe\x06\n" +
	"\x13SecurityErrorReason\x12%\n" +
	"!SECURITY_ERROR_REASON_UNSPECIFIED\x10\x00\x121\n" +
	",SECURITY_ERROR_REASON_INVALID_AUTHENTICATION\x10\xe8\a\x12)\n" +
	"$SECURITY_ERROR_REASON_INVALID_CLAIMS\x10\xe9\a\x12/\n" +
	"*SECURITY_ERROR_REASON_INVALID_BEARER_TOKEN\x10\xea\a\x12*\n" +
	"%SECURITY_ERROR_REASON_INVALID_SUBJECT\x10\xeb\a\x12+\n" +
	"&SECURITY_ERROR_REASON_INVALID_AUDIENCE\x10\xec\a\x12)\n" +
	"$SECURITY_ERROR_REASON_INVALID_ISSUER\x10\xed\a\x12-\n" +
	"(SECURITY_ERROR_REASON_INVALID_EXPIRATION\x10\xee\a\x12*\n" +
	"%SECURITY_ERROR_REASON_TOKEN_NOT_FOUND\x10\xef\a\x12/\n" +
	"*SECURITY_ERROR_REASON_BEARER_TOKEN_MISSING\x10\xf2\a\x12(\n" +
	"#SECURITY_ERROR_REASON_TOKEN_EXPIRED\x10\xf3\a\x125\n" +
	"0SECURITY_ERROR_REASON_UNSUPPORTED_SIGNING_METHOD\x10\xf4\a\x12+\n" +
	"&SECURITY_ERROR_REASON_MISSING_KEY_FUNC\x10\xf6\a\x12,\n" +
	"'SECURITY_ERROR_REASON_SIGN_TOKEN_FAILED\x10\xf7\a\x12)\n" +
	"$SECURITY_ERROR_REASON_GET_KEY_FAILED\x10\xf8\a\x120\n" +
	"+SECURITY_ERROR_REASON_INVALID_AUTHORIZATION\x10\xd0\x0f\x12%\n" +
	" SECURITY_ERROR_REASON_NO_AT_HASH\x10\x9a\b\x12*\n" +
	"%SECURITY_ERROR_REASON_INVALID_AT_HASH\x10\x9b\b\x12/\n" +
	"*SECURITY_ERROR_REASON_UNSECURITY_ENTICATED\x10\xb8\x17\x1a\x04\xa0E\xf4\x03B\xc6\x01\n" +
