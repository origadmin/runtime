...
const file_config_v1_security_proto_rawDesc = "" +
	...
	"\x05authn\x18\x03 \x01(\v2\x16.config.v1.AuthNConfigR\x05authnB\x9e\x01\n" +
	"\rcom.config.v1B\rSecurityProtoP\x01Z6github.com/origadmin/runtime/gen/go/config/v1;configv1\xf8\x01\x01\xa2\x02\x03CXX\xaa\x02\tConfig.V1\xca\x02\tConfig\\V1\xe2\x02\x15Config\\V1\\GPBMetadata\xea\x02\n" +
