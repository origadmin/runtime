...
const file_config_v1_registry_proto_rawDesc = "" +
	"\n" +
	"\x18config/v1/registry.proto\x12\tconfig.v1\x1a\x19config/v1/customize.proto\x1a\x17validate/validate.proto\"\xc8\x05\n" +
	"\bRegistry\x12Q\n" +
	...
	"\tcustomize\x18\x06 \x01(\v2\x14.config.v1.CustomizeR\tcustomize\x128\n" +
	"\x06consul\x18\xac\x02 \x01(\v2\x1a.config.v1.Registry.ConsulH\x00R\x06consul\x88\x01\x01\x122\n" +
	"\x04etcd\x18\x90\x03 \x01(\v2\x18.config.v1.Registry.ETCDH\x01R\x04etcd\x88\x01\x01\x1a\xd2\x02\n" +
	"\x06Consul\x12\x18\n" +
	...
	"\a_consulB\a\n" +
	"\x05_etcdB\x9e\x01\n" +
	"\rcom.config.v1B\rRegistryProtoP\x01Z6github.com/origadmin/runtime/gen/go/config/v1;configv1\xf8\x01\x01\xa2\x02\x03CXX\xaa\x02\tConfig.V1\xca\x02\tConfig\\V1\xe2\x02\x15Config\\V1\\GPBMetadata\xea\x02\n" +
...
var file_config_v1_registry_proto_depIdxs = []int32{
	3, // 0: config.v1.Registry.customize:type_name -> config.v1.Customize
	1, // 1: config.v1.Registry.consul:type_name -> config.v1.Registry.Consul
	2, // 2: config.v1.Registry.etcd:type_name -> config.v1.Registry.ETCD
