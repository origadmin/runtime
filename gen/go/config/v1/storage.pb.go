...
const file_config_v1_storage_proto_rawDesc = "" +
	...
	"\x03oss\x18\x0e \x01(\v2\x0e.config.v1.OssB\x1f\xbaG\x1c\x92\x02\x19oss storage configurationR\x03ossB\x9d\x01\n" +
	"\rcom.config.v1B\fStorageProtoP\x01Z6github.com/origadmin/runtime/gen/go/config/v1;configv1\xf8\x01\x01\xa2\x02\x03CXX\xaa\x02\tConfig.V1\xca\x02\tConfig\\V1\xe2\x02\x15Config\\V1\\GPBMetadata\xea\x02\n" +
