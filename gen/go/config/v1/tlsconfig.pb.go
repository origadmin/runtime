...
const file_config_v1_tlsconfig_proto_rawDesc = "" +
	...
	"\x02ca\x18\x03 \x01(\fR\x02caB\x9f\x01\n" +
	"\rcom.config.v1B\x0eTlsconfigProtoP\x01Z6github.com/origadmin/runtime/gen/go/config/v1;configv1\xf8\x01\x01\xa2\x02\x03CXX\xaa\x02\tConfig.V1\xca\x02\tConfig\\V1\xe2\x02\x15Config\\V1\\GPBMetadata\xea\x02\n" +
