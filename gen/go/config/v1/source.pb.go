...
const file_config_v1_source_proto_rawDesc = "" +
	"\n" +
	"\x16config/v1/source.proto\x12\tconfig.v1\x1a\x17validate/validate.proto\"\xed\x05\n" +
	"\fSourceConfig\x12W\n" +
	...
	"\x04etcd\x18\xac\x02 \x01(\v2\x1c.config.v1.SourceConfig.ETCDH\x02R\x04etcd\x88\x01\x01\x1a2\n" +
	"\x04File\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x16\n" +
	"\x06format\x18\x02 \x01(\tR\x06format\x1ad\n" +
	"\x06Consul\x12\x18\n" +
	...
	"\a_consulB\a\n" +
	"\x05_etcdB~\n" +
	"&com.github.origadmin.runtime.config.v1B\x11SourceConfigProtoP\x01Z6github.com/origadmin/runtime/gen/go/config/v1;configv1\xf8\x01\x01\xa2\x02\x03ORCb\x06proto3"
