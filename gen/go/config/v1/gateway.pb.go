...
const file_config_v1_gateway_proto_rawDesc = "" +
	...
	"\x04GRPC\x10\x02\x12\n" +
	"\n" +
	"\x06CUSTOM\x10\x03B\x9d\x01\n" +
	"\rcom.config.v1B\fGatewayProtoP\x01Z6github.com/origadmin/runtime/gen/go/config/v1;configv1\xf8\x01\x01\xa2\x02\x03CXX\xaa\x02\tConfig.V1\xca\x02\tConfig\\V1\xe2\x02\x15Config\\V1\\GPBMetadata\xea\x02\n" +
