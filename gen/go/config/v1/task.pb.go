...
const file_config_v1_task_proto_rawDesc = "" +
	...
	"\x04Cron\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addrB\x9a\x01\n" +
	"\rcom.config.v1B\tTaskProtoP\x01Z6github.com/origadmin/runtime/gen/go/config/v1;configv1\xf8\x01\x01\xa2\x02\x03CXX\xaa\x02\tConfig.V1\xca\x02\tConfig\\V1\xe2\x02\x15Config\\V1\\GPBMetadata\xea\x02\n" +
