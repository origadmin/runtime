...
const file_middleware_metrics_v1_metrics_proto_rawDesc = "" +
	"\n" +
	"#middleware/metrics/v1/metrics.proto\x12\x15middleware.metrics.v1\"\x82\x05\n" +
	"\n" +
	"UserMetric\x12\x1c\n" +
	"\ttimestamp\x18\x01 \x01(\x03R\ttimestamp\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x03 \x01(\x01R\x05value\x12E\n" +
	"\x06labels\x18\x04 \x03(\v2-.middleware.metrics.v1.UserMetric.LabelsEntryR\x06labels\x12\x12\n" +
	"\x04unit\x18\x05 \x01(\tR\x04unit\x12@\n" +
	"\x04type\x18\x06 \x01(\x0e2,.middleware.metrics.v1.UserMetric.MetricTypeR\x04type\x12 \n" +
	"\vdescription\x18\a \x01(\tR\vdescription\x12\x18\n" +
	"\acontext\x18\b \x01(\tR\acontext\x12K\n" +
	"\bmetadata\x18\t \x03(\v2/.middleware.metrics.v1.UserMetric.MetadataEntryR\bmetadata\x1a9\n" +
	...
	"\fuser_metrics\x18\x06 \x03(\v2!.middleware.metrics.v1.UserMetricR\fuser_metricsB\xe7\x01\n" +
	"\x19com.middleware.metrics.v1B\fMetricsProtoP\x01ZCgithub.com/origadmin/runtime/gen/go/middleware/metrics/v1;metricsv1\xf8\x01\x01\xa2\x02\x03MMX\xaa\x02\x15Middleware.Metrics.V1\xca\x02\x15Middleware\\Metrics\\V1\xe2\x02!Middleware\\Metrics\\V1\\GPBMetadata\xea\x02\x17Middleware::Metrics::V1b\x06proto3"

var (
	file_middleware_metrics_v1_metrics_proto_rawDescOnce sync.Once
	file_middleware_metrics_v1_metrics_proto_rawDescData []byte
)
...
func file_middleware_metrics_v1_metrics_proto_rawDescGZIP() []byte {
	file_middleware_metrics_v1_metrics_proto_rawDescOnce.Do(func() {
		file_middleware_metrics_v1_metrics_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_middleware_metrics_v1_metrics_proto_rawDesc), len(file_middleware_metrics_v1_metrics_proto_rawDesc)))
	})
...
func file_middleware_metrics_v1_metrics_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_middleware_metrics_v1_metrics_proto_rawDesc), len(file_middleware_metrics_v1_metrics_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
