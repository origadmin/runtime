...
const file_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDesc = "" +
	"\n" +
	"1middleware/circuitbreaker/v1/circuitbreaker.proto\x12\x1cmiddleware.circuitbreaker.v1\x1a\x17config/v1/gateway.proto\"\xfa\x02\n" +
	"\x0eCircuitBreaker\x12Q\n" +
	"\rsuccess_ratio\x18\x01 \x01(\v2*.middleware.circuitbreaker.v1.SuccessRatioH\x00R\fsuccessRatio\x12\x16\n" +
	"\x05ratio\x18\x02 \x01(\x03H\x00R\x05ratio\x12Q\n" +
	"\rresponse_data\x18\x03 \x01(\v2*.middleware.circuitbreaker.v1.ResponseDataH\x01R\fresponseData\x12T\n" +
	"\x0ebackup_service\x18\x04 \x01(\v2+.middleware.circuitbreaker.v1.BackupServiceH\x01R\rbackupService\x12?\n" +
	...
	"statusCode\x12<\n" +
	"\x06header\x18\x02 \x03(\v2$.middleware.circuitbreaker.v1.HeaderR\x06header\x12\x12\n" +
	...
	"\x06window\x18\x04 \x01(\x03R\x06windowB\x9f\x02\n" +
	" com.middleware.circuitbreaker.v1B\x13CircuitbreakerProtoP\x01ZQgithub.com/origadmin/runtime/gen/go/middleware/circuitbreaker/v1;circuitbreakerv1\xf8\x01\x01\xa2\x02\x03MCX\xaa\x02\x1cMiddleware.Circuitbreaker.V1\xca\x02\x1cMiddleware\\Circuitbreaker\\V1\xe2\x02(Middleware\\Circuitbreaker\\V1\\GPBMetadata\xea\x02\x1eMiddleware::Circuitbreaker::V1b\x06proto3"

var (
	file_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDescOnce sync.Once
	file_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDescData []byte
)
...
func file_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDescGZIP() []byte {
	file_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDescOnce.Do(func() {
		file_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDesc), len(file_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDesc)))
	})
...
func file_middleware_circuitbreaker_v1_circuitbreaker_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDesc), len(file_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
