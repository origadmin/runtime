...
const file_middleware_ratelimit_v1_ratelimiter_proto_rawDesc = "" +
	"\n" +
	")middleware/ratelimit/v1/ratelimiter.proto\x12\x17middleware.ratelimit.v1\x1a\x17validate/validate.proto\"\xe4\x04\n" +
	...
	"\x06memory\x18e \x01(\v2+.middleware.ratelimit.v1.RateLimiter.MemoryR\x06memory\x12@\n" +
	"\x05redis\x18f \x01(\v2*.middleware.ratelimit.v1.RateLimiter.RedisR\x05redis\x1ac\n" +
	"\x05Redis\x12\x12\n" +
	...
	"expiration\x12*\n" +
	"\x10cleanup_interval\x18\x02 \x01(\x03R\x10cleanup_intervalB\xf9\x01\n" +
	"\x1bcom.middleware.ratelimit.v1B\x10RatelimiterProtoP\x01ZGgithub.com/origadmin/runtime/gen/go/middleware/ratelimit/v1;ratelimitv1\xf8\x01\x01\xa2\x02\x03MRX\xaa\x02\x17Middleware.Ratelimit.V1\xca\x02\x17Middleware\\Ratelimit\\V1\xe2\x02#Middleware\\Ratelimit\\V1\\GPBMetadata\xea\x02\x19Middleware::Ratelimit::V1b\x06proto3"

var (
	file_middleware_ratelimit_v1_ratelimiter_proto_rawDescOnce sync.Once
	file_middleware_ratelimit_v1_ratelimiter_proto_rawDescData []byte
)
...
func file_middleware_ratelimit_v1_ratelimiter_proto_rawDescGZIP() []byte {
	file_middleware_ratelimit_v1_ratelimiter_proto_rawDescOnce.Do(func() {
		file_middleware_ratelimit_v1_ratelimiter_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_middleware_ratelimit_v1_ratelimiter_proto_rawDesc), len(file_middleware_ratelimit_v1_ratelimiter_proto_rawDesc)))
	})
...
func file_middleware_ratelimit_v1_ratelimiter_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_middleware_ratelimit_v1_ratelimiter_proto_rawDesc), len(file_middleware_ratelimit_v1_ratelimiter_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
